	...
	<header>
		<div class="navbar navbar-inverse navbar-fixed-top">
			<div class="navbar-inner">
				<div class="container">
					<a class="brand" href="<?php echo $this->Html->url(array('plugin' => '', 'action'=>'index', 'controller'=>'pages')); ?>">HOME</a>
					<ul class="nav pull-left">
						...
						<li><a href="<?php echo $this->Html->url( array('controller'=>'User','action'=>'reset_password')); ?>">Reset Password</a></li>
					</ul>
