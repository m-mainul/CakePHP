...
$("#QuestionaireQ3UnitHeadGender").mouseup(function() { 
  if($('#QuestionaireQ2UnitName').val() == '' || $('#QuestionaireQ2VillageMaholla').val() == '' ) autoFocus("QuestionaireQ2VillageMaholla");
});
...
$("#QuestionaireQ4UnitType").mouseup(function() { 
  ...
  if(val.length != 2) autoFocus("QuestionaireQ3UnitHeadAge");
});

$("#QuestionaireQ5UnitHeadEconomyId").mouseup(function() { 
  if($('#QuestionaireQ4UnitType').val() == '') autoFocus("QuestionaireQ4UnitType");
});
...
$("#QuestionaireQ16FixedCapital").mouseup(function() { 
  if($('#QuestionaireQ15SalaryInstr').val() == '' || $('#QuestionaireQ15SalaryPeriod').val() == '' ) autoFocus("QuestionaireQ15SalaryInstr");
});
