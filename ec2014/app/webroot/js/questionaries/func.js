...
function submit_form()
{
		...
		load_start();
		var action = $('#QuestionaireAddForm').attr('action');
		
		var path1 = action.split('add');
		var path2 = path1[0]; 
		var finalAction = path1[0]+"partialSubmit/"+$('#QuestionaireBookId').val();
		$("#QuestionaireAddForm").attr("action", finalAction);
		$('#QuestionaireAddForm').submit(); 
