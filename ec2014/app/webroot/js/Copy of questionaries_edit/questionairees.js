$(document).ready(function() {
	...
	$("#QuestionaireQ2HoldingNo").blur(function() {
		if($(this).val() == '')
			alert("এই ঘরটি ফাঁকা। আপনি কি নিশ্চিত?");

	});

	$("#QuestionaireQ2RoadNoName, #QuestionaireQ2TelephoneNo").blur(function() {
		if($(this).val() == '') {
			var value = confirm("এই ঘরটি ফাঁকা। আপনি কি নিশ্চিত?");
			if(value) {
				alert("এই ঘরটি ফাঁকা। আপনি কি নিশ্চিত?");
			} else {
				alert("এই ঘরটি ফাঁকা। আপনি কি নিশ্চিত?");
	...
	$("#QuestionaireQ9LegalEntityTypeId").keyup(function() {
		...
		if(value.length >= 2 && (valueInt < 01 || valueInt > 12 )) {
			$(this).val("");
			autoFocus("QuestionaireQ9LegalEntityTypeId");
			alert("ভুল কোড");
			return false;
	...
	$("#QuestionaireQ27YearVatRegistered").keyup(function() {
		...
		if(val.length >= 4 && (val2 < startYear2 || val2 > 2013)) {
			$(this).val("");
			autoFocus("QuestionaireQ27YearVatRegistered");
			alert("নিবন্ধনের সাল সঠিক নয়।");
		}
...
/*
		if(value.length == 2 && $('#QuestionaireQ4UnitType').val() == '1' && (value == '01' || value == '02' || value == '14' || value == '15' || value == '16')) {
	...
	if(value.length == 4 && $('#QuestionaireQ4UnitType').val() == '1') {
       	...
       	{
       			var value = confirm("ভুল কোড এন্ট্রি করেছেন! আপনি কি নিশ্চিত?");
            	if(value) 
            	{
            	var value = confirm("এই ইউনিটটি পূরণ করার দরকার নেই, দয়া করে পরবর্তী ইউনিটে যান");
                submit_form();
                } 
            	else 
            	{
       	...
       	else if ((value >= '1811' && value <= '2029') || (value >= '2104' && value <= '2211') || (value >= '2410' && value <= '2420') || (value >= '2910' && value <= '3011') ||  (value >= '3013' && value <= '3091') || (value >= '4100' && value <= '4530') || value == '4651' || (value >= '4911' && value <= '4912') || (value >= '5223' && value <= '5320') || (value >= '5811' && value <= '6190') || (value >= '6391' && value <= '6621') || (value >= '8411' && value <= '8541') || (value >= '9101' && value <= '9602') || value == '9900')
       	{
       		var value = confirm("ভুল কোড এন্ট্রি করেছেন! আপনি কি নিশ্চিত?");
            	if(value) 
            	{
	...
	//Input field Enable/Diasable for Section 10==========================================
	...
	option_q15_2[4] = '4-অন্যান্য';
	option_q15_2[5] = '5-প্রযোজ্য নয়';
	option_q15_2[9] = '9-তথ্য নেই!';
	...
	//SECTION 18======================================
	option_q18[1] = 'বিদ্যুৎ চালিত ...1';
	option_q18[2] = 'ফুয়েল চালিত....2';
	option_q18[3] = 'উভয়ই....3';
	option_q18[4] = 'হস্তচালিত....4';
	option_q18[5] = 'প্রযোজ্য নয়....5';
	...
	option_q19[1] = 'সম্পূর্ন স্থানীয়....1';
	option_q19[2] = 'সম্পূর্ন রপ্তানি ....2';
	option_q19[3] = 'স্থানীয় ও রপ্তানি....3';
	option_q19[4] = 'প্রযোজ্য নয়......4';
	...
	option_q20[1] = 'বিদ্যুৎ.....1';
	option_q20[2] = 'সৌরবিদ্যুৎ ....2';
	option_q20[3] = 'গ্যাস.....3';
	option_q20[4] = 'পেট্রোলিয়াম ....4';
	option_q20[5] = 'কয়লা......5';
	option_q20[6] = 'কাঠ......6';
	option_q20[7] = 'অন্যান্য......7';
	option_q20[8] = 'অন্যান্য......8';
	...
	option_yes_no[1] = 'হ্যাঁ.....1';
	option_yes_no[2] = 'না......2';
	...
	$('#QuestionaireQ1GeoCodeMauzaId').change(function() {
		...
		path1 = path[0] + "/questionaires/getMuzaName";
		path2 = path[0] + "/questionaires/getVillageName";
		...
		$.ajax({
			...
			success : function(data) {
				...
				$.each(data, function(index, element) {
					...
					chk = "YES";
					get_village_edit(path2, selectvalue, $('#QuestionaireBookId').val());
				});
				if(chk == "NO") {
	...
	$("#QuestionaireRmoCode").change(function() {
		...
		var pathname = window.location.pathname;
		var path = pathname.split('/QuesChecks');
		path = path[0] + "questionaires/getRmoName";
	...
	$('#QuestionaireQ1UnitSerialNo').change(function() {
		...
		var pathname = window.location.pathname;
		var path = pathname.split('/QuesChecks');
		path = path[0] + "/questionaires/getUnitNumber";
	...
	$('#QuestionaireQ3UnitHeadEducationId').change(function() {
		...
		var pathname = window.location.pathname;
		var path = pathname.split('/QuesChecks');
		path = path[0] + "/questionaires/getEductionDesc";
		...
		$.ajax({
			...
			success : function(data) {
				$('#q3unitheadheducation').html("<div id='invalidCode'>ভুল কোড!</div>");
				var chk = "NO";
				$.each(data, function(index, element) {
	...
	$('#QuestionaireQ5UnitHeadEconomyId').change(function() {
		...
		var pathname = window.location.pathname;
		var path = pathname.split('/QuesChecks');
		path = path[0] + "/questionaires/getEconomyDesc";
	...
	$('#QuestionaireRmoCode').keyup(function() {
		...
		if(value2.length == 1) {
			if(value == 1 || value == 3 || value == 5 || value == 7) {
				...
				alert("RMO কোডটি সঠিক নয়। সঠিক কোড হবে 1, 3, 5  অথবা  7");
			}
		}
	});
