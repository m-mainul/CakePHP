...
//console.log("sdfj sdfhjkldhskfh");
...
function submit_form()
{
        ...
        load_start();
        var action = $('#QuestionaireEditQuesForm').attr('action');
        var path1 = action.split('Pages');
        var path2 = path1[0]; 
        var finalAction = path1[0]+"/Questionaires/partialSubmitEdit/"+$('#QuestionaireBookId').val();
        $("#QuestionaireEditQuesForm").attr("action", finalAction);
        $('#QuestionaireEditQuesForm').submit();
