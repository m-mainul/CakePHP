...
$(document).ready(function() {
	...
	$("#QuestionaireQ9LegalEntityTypeId, #QuestionaireQ17HrMale, #QuestionaireQ17HrFemale, #QuestionaireQ17HrMaleFoc, #QuestionaireQ17HrFemaleFoc, #QuestionaireQ17HrMaleIrregular, #QuestionaireQ17HrFemaleIrregular").live("keydown", function(e) {
		var key = e.charCode || e.keyCode || 0;
		var val = $(this).val();
	...
	// TAB VALIDATION FOR SECTION ONE - 4 DIGIT
	$("#QuestionaireQ17HrMaleFulltime,#QuestionaireQ17HrFemaleFulltime").live("keydown", function(e) {
		var key = e.charCode || e.keyCode || 0;
		var val = $(this).val();
	...
	$("#QuestionaireQ1GeoCodeMauzaId,#QuestionaireQ1UnitSerialNo,#QuestionaireQ17HrMaleParttime,#QuestionaireQ17HrFemaleParttime").live("keydown", function(e) {
		var key = e.charCode || e.keyCode || 0;
		var val = $(this).val();
