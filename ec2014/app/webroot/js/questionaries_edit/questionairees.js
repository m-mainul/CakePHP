...
$('#QuestionaireQ2UnitName').on("paste",function(e)
{
    e.preventDefault();
});
	...
	$("#QuestionaireQ2RoadNoName").blur(function() {
		...
		if($(this).val() == '') {
			...
			if(value) {
				alert("এই ঘরটি ফাঁকা। আপনি কি আবারও নিশ্চিত?");
			} else {
	...
	$("#QuestionaireQ12YearOfStart").keyup(function() {
		...
		if(value.length >= 4 && startYear <= 1900) {
			...
			if(startYear == 0000) {
				$('#q12details').html("<div>তথ্য নেই!</div>");
			} else {
	...
	option_q20[8] = 'প্রযোজ্য নয়....8';
	option_q20[9] = 'তথ্য নেই!......9';
