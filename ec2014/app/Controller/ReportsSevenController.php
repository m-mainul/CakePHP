...
class ReportsSevenController extends AppController {
...
#----------------------------------------------SIX------------------------------------------------------
	...
	public function tpe_tbl_seven_three() {
        ...
        if ($this -> request -> is('post')) {
            ...
            $result_I = $this->_prepate_result_seven_three("Accommodation and food service activities (Hotel and restaurants)", $where, "BETWEEN 55 AND 56");
            ...
            $result_L = $this->_prepate_result_seven_three("Real Estate activities", $where, "= 68");
		...
		$db = get_class_vars('DATABASE_CONFIG');
			...
			if (!$conn) {
				...
				$sql = "SELECT '".$activity."' AS BSIC_DESCRIPTION, COUNT(REPORT.QUESTIONNARIE_ID) AS TOTAL_EST, 
						    (SELECT COUNT(R_ONE.QUESTIONNARIE_ID)  AS F_A_1 FROM BBSEC2013_REPORTS  R_ONE 
						    WHERE ".$where." AND F_TO_NUMBER(SUBSTR(R_ONE.Q6_IND_CODE_CLASS_CODE,1,2)) ".$between."  
						    AND R_ONE.Q9_LEGAL_ENTITY_TYPE_ID = '01' AND R_ONE.Q4_UNIT_TYPE = 2 AND R_ONE.Q4_UNIT_ORG_TYPE = 1)  AS F_A_1,
						    
						    (SELECT COUNT(R_TWO.QUESTIONNARIE_ID)  AS F_A_2 FROM BBSEC2013_REPORTS  R_TWO 
						    WHERE ".$where." AND F_TO_NUMBER(SUBSTR(R_TWO.Q6_IND_CODE_CLASS_CODE,1,2)) ".$between."  
						    AND R_TWO.Q9_LEGAL_ENTITY_TYPE_ID = '02' AND R_TWO.Q4_UNIT_TYPE = 2 AND R_TWO.Q4_UNIT_ORG_TYPE = 1)  AS F_A_2,
						    
						    (SELECT COUNT(R_THREE.QUESTIONNARIE_ID) AS  F_A_3 FROM BBSEC2013_REPORTS  R_THREE
						    WHERE ".$where." AND F_TO_NUMBER(SUBSTR(R_THREE.Q6_IND_CODE_CLASS_CODE,1,2)) ".$between."  
						    AND R_THREE.Q9_LEGAL_ENTITY_TYPE_ID = '03' AND R_THREE.Q4_UNIT_TYPE = 2 AND R_THREE.Q4_UNIT_ORG_TYPE = 1)  AS F_A_3,
						    
						    (SELECT COUNT(R_FOUR.QUESTIONNARIE_ID) AS  F_A_4 FROM BBSEC2013_REPORTS  R_FOUR 
						    WHERE ".$where." AND F_TO_NUMBER(SUBSTR(R_FOUR.Q6_IND_CODE_CLASS_CODE,1,2)) ".$between." 
						    AND R_FOUR.Q9_LEGAL_ENTITY_TYPE_ID = '04' AND R_FOUR.Q4_UNIT_TYPE = 2 AND R_FOUR.Q4_UNIT_ORG_TYPE = 1)  AS F_A_4,
						    
						    (SELECT COUNT(R_FIVE.QUESTIONNARIE_ID)  AS F_A_5 FROM BBSEC2013_REPORTS  R_FIVE
						    WHERE ".$where." AND F_TO_NUMBER(SUBSTR(R_FIVE.Q6_IND_CODE_CLASS_CODE,1,2)) ".$between." 
						    AND R_FIVE.Q9_LEGAL_ENTITY_TYPE_ID = '05' AND R_FIVE.Q4_UNIT_TYPE = 2 AND R_FIVE.Q4_UNIT_ORG_TYPE = 1) AS  F_A_5,
						    ...
						    AND R_SIX.Q9_LEGAL_ENTITY_TYPE_ID = '06' AND R_SIX.Q4_UNIT_TYPE = 2 AND R_SIX.Q4_UNIT_ORG_TYPE = 1)  AS F_A_6,
						    ...
						    AND R_SEVEN.Q9_LEGAL_ENTITY_TYPE_ID = '07' AND R_SEVEN.Q4_UNIT_TYPE = 2 AND R_SEVEN.Q4_UNIT_ORG_TYPE = 1)  AS F_A_7,
						    ...
						    AND R_EIGHT.Q9_LEGAL_ENTITY_TYPE_ID = '08' AND R_EIGHT.Q4_UNIT_TYPE = 2 AND R_EIGHT.Q4_UNIT_ORG_TYPE = 1)  AS F_A_8,
						    ...
						    AND R_NINE.Q9_LEGAL_ENTITY_TYPE_ID = '09' AND R_NINE.Q4_UNIT_TYPE = 2 AND R_NINE.Q4_UNIT_ORG_TYPE = 1)  AS F_A_9,
						    ...
						    AND R_TEN.Q9_LEGAL_ENTITY_TYPE_ID = '10' AND R_TEN.Q4_UNIT_TYPE = 2 AND R_TEN.Q4_UNIT_ORG_TYPE = 1)  AS F_A_10,
						    ...
						    AND R_ELEVEN.Q9_LEGAL_ENTITY_TYPE_ID = '11' AND R_ELEVEN.Q4_UNIT_TYPE = 2 AND R_ELEVEN.Q4_UNIT_ORG_TYPE = 1) AS  F_A_11,
						    ...
						    AND R_TWELEVE.Q9_LEGAL_ENTITY_TYPE_ID  = '12' AND R_TWELEVE.Q4_UNIT_TYPE = 2 AND R_TWELEVE.Q4_UNIT_ORG_TYPE = 1)  AS F_A_12
...
public function tpe_tbl_seven_four() {
        ...
        if ($this -> request -> is('post')) {
            ...
            $result_I = $this->_prepate_result_seven_four("Accommodation and food service activities (Hotel and Restaurants)", $where, "BETWEEN 55 AND 56");
            ...
            $result_L = $this->_prepate_result_seven_four("Real Estate activities", $where, "= 68");
	...
	public function _prepate_result_seven_four($activity, $where, $between)
	{
		$db = get_class_vars('DATABASE_CONFIG');
			...
			if (!$conn) {
				...
				$sql = "SELECT '".$activity."' AS BSIC_DESCRIPTION, SUM(REPORT.TOTAL_PERSON_ENGAGED) AS TOTAL_EST, 
						    (SELECT SUM(R_ONE.TOTAL_PERSON_ENGAGED)  AS F_A_1 FROM BBSEC2013_REPORTS  R_ONE 
						    WHERE ".$where." AND F_TO_NUMBER(SUBSTR(R_ONE.Q6_IND_CODE_CLASS_CODE,1,2)) ".$between."  
						    AND R_ONE.Q9_LEGAL_ENTITY_TYPE_ID = '01' AND R_ONE.Q4_UNIT_TYPE = 2 AND R_ONE.Q4_UNIT_ORG_TYPE = 1)  AS F_A_1,
...
public function tpe_tbl_seven_five_ajax() {
        $this -> autoRender = false;
        $this -> layout = false;
        
        if(isset($_SESSION['t_7_5'])) echo json_encode($_SESSION['t_7_5']);
		...
		$db = get_class_vars('DATABASE_CONFIG');
			...
			$sql = "SELECT REPORT.GEO_CODE_UPAZILA_ID, REPORT.UPZILA_NAME,
					COUNT(REPORT.QUESTIONNARIE_ID) AS TOTAL_EST, 
                        ...
                        AND  REPORT_1.GEO_CODE_UPAZILA_ID = REPORT.GEO_CODE_UPAZILA_ID) REGISTERED ,
                        (SELECT COUNT(REPORT_1.QUESTIONNARIE_ID) FROM BBSEC2013_REPORTS  REPORT_1 WHERE REPORT_1.Q11_IS_REGISTERED = '2' 
                        AND  REPORT_1.GEO_CODE_UPAZILA_ID = REPORT.GEO_CODE_UPAZILA_ID)  NON_REGISTERED,
		...
		$db = get_class_vars('DATABASE_CONFIG');
			...
			$sql = "SELECT REPORT.GEO_CODE_UPAZILA_ID, REPORT.UPZILA_NAME,
					COUNT(REPORT.QUESTIONNARIE_ID) AS TOTAL_EST, 
                        ...
                        AND  REPORT_1.GEO_CODE_UPAZILA_ID = REPORT.GEO_CODE_UPAZILA_ID)  RETAIL,
                        (SELECT COUNT(REPORT_1.QUESTIONNARIE_ID) FROM BBSEC2013_REPORTS  REPORT_1 WHERE REPORT_1.Q13_SALE_PROCEDURE = '2' 
                        AND  REPORT_1.GEO_CODE_UPAZILA_ID = REPORT.GEO_CODE_UPAZILA_ID)  WHOLESALE,
                        ...
                        AND  REPORT_1.GEO_CODE_UPAZILA_ID = REPORT.GEO_CODE_UPAZILA_ID)  ACCOUNT,
                          (SELECT COUNT(REPORT_1.QUESTIONNARIE_ID) FROM BBSEC2013_REPORTS  REPORT_1 WHERE REPORT_1.Q14_IS_ACCOUNTABLE != '1'
                        AND  REPORT_1.GEO_CODE_UPAZILA_ID = REPORT.GEO_CODE_UPAZILA_ID) NOT_ACCOUNT
						FROM BBSEC2013_REPORTS REPORT
						WHERE" .$where.
						"GROUP BY REPORT.GEO_CODE_UPAZILA_ID, REPORT.UPZILA_NAME
						 ORDER BY REPORT.UPZILA_NAME";
