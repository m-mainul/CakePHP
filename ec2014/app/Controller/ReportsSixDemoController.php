...
class ReportsSixDemoController extends AppController {
		...
		$db = get_class_vars('DATABASE_CONFIG');
			...
			$sql = "SELECT REPORT.GEO_CODE_UNION_ID, REPORT.UNION_NAME,
					COUNT(REPORT.QUESTIONNARIE_ID) AS TOTAL_EST, 
                        ...
                        AND  REPORT_1.GEO_CODE_UNION_ID = REPORT.GEO_CODE_UNION_ID)  Power_Operating,
                        (SELECT COUNT(REPORT_1.QUESTIONNARIE_ID) FROM BBSEC2013_REPORTS  REPORT_1 WHERE REPORT_1.Q18_MACHINE_USES = '2' 
                        AND  REPORT_1.GEO_CODE_UNION_ID = REPORT.GEO_CODE_UNION_ID)  Fuel_Operating,
                          (SELECT COUNT(REPORT_1.QUESTIONNARIE_ID) FROM BBSEC2013_REPORTS  REPORT_1 WHERE REPORT_1.Q18_MACHINE_USES = '3' 
                        AND  REPORT_1.GEO_CODE_UNION_ID = REPORT.GEO_CODE_UNION_ID)  Both_Operating,
                          (SELECT COUNT(REPORT_1.QUESTIONNARIE_ID) FROM BBSEC2013_REPORTS  REPORT_1 WHERE REPORT_1.Q18_MACHINE_USES = '4' 
                        AND  REPORT_1.GEO_CODE_UNION_ID = REPORT.GEO_CODE_UNION_ID)  Hand_Operating,
                          (SELECT COUNT(REPORT_1.QUESTIONNARIE_ID) FROM BBSEC2013_REPORTS  REPORT_1 WHERE REPORT_1.Q18_MACHINE_USES = '5' 
                        AND  REPORT_1.GEO_CODE_UNION_ID = REPORT.GEO_CODE_UNION_ID)  Not_appilcable
						FROM BBSEC2013_REPORTS REPORT
						WHERE" .$where.
						"AND F_TO_NUMBER(SUBSTR(Q6_IND_CODE_CLASS_CODE,1,2)) BETWEEN 10 AND 33  GROUP BY REPORT.GEO_CODE_UNION_ID, REPORT.UNION_NAME
	...
	public function _prepate_result_six_five ($where)
	{
		$db = get_class_vars('DATABASE_CONFIG');
			...
			$sql = "SELECT REPORT.GEO_CODE_UNION_ID, REPORT.UNION_NAME, COUNT(REPORT.QUESTIONNARIE_ID) 
			AS TOTAL_EST,
				(SELECT COUNT(REPORT_1.QUESTIONNARIE_ID) FROM BBSEC2013_REPORTS REPORT_1 WHERE
				 REPORT_1.Q19_MARKETING = '1' 
				AND REPORT_1.GEO_CODE_UNION_ID = REPORT.GEO_CODE_UNION_ID) TOTALLY_LOCAL, 
				(SELECT COUNT(REPORT_1.QUESTIONNARIE_ID)
				FROM BBSEC2013_REPORTS REPORT_1 WHERE REPORT_1.Q19_MARKETING = '2' 
				AND REPORT_1.GEO_CODE_UNION_ID = REPORT.GEO_CODE_UNION_ID) TOTALLY_EXPORT, 
				(SELECT COUNT(REPORT_1.QUESTIONNARIE_ID) FROM BBSEC2013_REPORTS REPORT_1 WHERE 
					REPORT_1.Q19_MARKETING = '3'
				AND REPORT_1.GEO_CODE_UNION_ID = REPORT.GEO_CODE_UNION_ID) LOCAL_EXPORT,
				 (SELECT COUNT(REPORT_1.QUESTIONNARIE_ID)
	...
	public function _prepate_result_six_six ($where)
	{
		$db = get_class_vars('DATABASE_CONFIG');
			...
			$sql = "SELECT REPORT.GEO_CODE_UNION_ID, REPORT.UNION_NAME, COUNT(REPORT.QUESTIONNARIE_ID) AS TOTAL_EST,
(SELECT COUNT(REPORT_1.QUESTIONNARIE_ID) FROM BBSEC2013_REPORTS REPORT_1 WHERE REPORT_1.Q20_FUEL_USES = '1' 
AND REPORT_1.GEO_CODE_UNION_ID = REPORT.GEO_CODE_UNION_ID) Electricity,
(SELECT COUNT(REPORT_1.QUESTIONNARIE_ID)
FROM BBSEC2013_REPORTS REPORT_1 WHERE REPORT_1.Q20_FUEL_USES = '2' AND REPORT_1.GEO_CODE_UNION_ID = REPORT.GEO_CODE_UNION_ID) Solar , 
(SELECT COUNT(REPORT_1.QUESTIONNARIE_ID) FROM BBSEC2013_REPORTS REPORT_1 WHERE REPORT_1.Q20_FUEL_USES = '3'
AND REPORT_1.GEO_CODE_UNION_ID = REPORT.GEO_CODE_UNION_ID) Gas, 
(SELECT COUNT(REPORT_1.QUESTIONNARIE_ID)
FROM BBSEC2013_REPORTS REPORT_1 WHERE REPORT_1.Q20_FUEL_USES = '4' AND REPORT_1.GEO_CODE_UNION_ID = REPORT.GEO_CODE_UNION_ID) Petroliam,
(SELECT COUNT(REPORT_1.QUESTIONNARIE_ID) FROM BBSEC2013_REPORTS REPORT_1 WHERE REPORT_1.Q20_FUEL_USES = '5'
AND REPORT_1.GEO_CODE_UNION_ID = REPORT.GEO_CODE_UNION_ID) Coal,
(SELECT COUNT(REPORT_1.QUESTIONNARIE_ID)
FROM BBSEC2013_REPORTS REPORT_1 WHERE REPORT_1.Q20_FUEL_USES = '6' AND REPORT_1.GEO_CODE_UNION_ID = REPORT.GEO_CODE_UNION_ID) Wood,
(SELECT COUNT(REPORT_1.QUESTIONNARIE_ID) FROM BBSEC2013_REPORTS REPORT_1 WHERE REPORT_1.Q20_FUEL_USES = '7'
AND REPORT_1.GEO_CODE_UNION_ID = REPORT.GEO_CODE_UNION_ID) Other, 
(SELECT COUNT(REPORT_1.QUESTIONNARIE_ID)
FROM BBSEC2013_REPORTS REPORT_1 WHERE REPORT_1.Q20_FUEL_USES = '8' AND REPORT_1.GEO_CODE_UNION_ID = REPORT.GEO_CODE_UNION_ID) NOT_APPLICABLE
				FROM BBSEC2013_REPORTS REPORT 
						WHERE" .$where.
						"AND F_TO_NUMBER(SUBSTR(Q6_IND_CODE_CLASS_CODE,1,2)) BETWEEN 10 AND 33 GROUP BY REPORT.GEO_CODE_UNION_ID, REPORT.UNION_NAME
						 ORDER BY REPORT.UNION_NAME";  
	...
	public function _prepate_result_six_seven ($where)
	{
		$db = get_class_vars('DATABASE_CONFIG');
			...
			$sql = "SELECT REPORT.GEO_CODE_UNION_ID, REPORT.UNION_NAME, COUNT(REPORT.QUESTIONNARIE_ID) AS TOTAL_EST,
					...
					AND REPORT_1.GEO_CODE_UNION_ID = REPORT.GEO_CODE_UNION_ID) ENABLED, 
					(SELECT COUNT(REPORT_1.QUESTIONNARIE_ID)
					FROM BBSEC2013_REPORTS REPORT_1 WHERE REPORT_1.Q21_IS_IT_ENABLED != '1' AND 
					REPORT_1.GEO_CODE_UNION_ID = REPORT.GEO_CODE_UNION_ID) NOT_ENABLED 
					FROM BBSEC2013_REPORTS REPORT 
					WHERE" .$where.
					"AND F_TO_NUMBER(SUBSTR(Q6_IND_CODE_CLASS_CODE,1,2)) BETWEEN 10 AND 33 GROUP BY REPORT.GEO_CODE_UNION_ID, REPORT.UNION_NAME
					ORDER BY REPORT.UNION_NAME";
	...
	public function _prepate_result_six_eight ($where)
	{
		$db = get_class_vars('DATABASE_CONFIG');
			...
			$sql = "SELECT REPORT.GEO_CODE_UNION_ID, REPORT.UNION_NAME, COUNT(REPORT.QUESTIONNARIE_ID) AS TOTAL_EST,
					...
					AND REPORT_1.GEO_CODE_UNION_ID = REPORT.GEO_CODE_UNION_ID) TIN_REGISTERED, 
					(SELECT COUNT(REPORT_1.QUESTIONNARIE_ID)
					FROM BBSEC2013_REPORTS REPORT_1 WHERE REPORT_1.Q25_IS_TIN_REGISTERED = '2' 
					AND REPORT_1.GEO_CODE_UNION_ID = REPORT.GEO_CODE_UNION_ID) TIN_NOT_REGISTERED 
					FROM BBSEC2013_REPORTS REPORT 
					WHERE" .$where.
	...
	public function _prepate_result_six_ten ($where)
	{
		$db = get_class_vars('DATABASE_CONFIG');
			...
			$sql = "SELECT REPORT.GEO_CODE_UNION_ID, REPORT.UNION_NAME, COUNT(REPORT.QUESTIONNARIE_ID) AS TOTAL_EST,
					...
					AND REPORT_1.GEO_CODE_UNION_ID = REPORT.GEO_CODE_UNION_ID) VAT_REGISTERED, 
					(SELECT COUNT(REPORT_1.QUESTIONNARIE_ID)
					FROM BBSEC2013_REPORTS REPORT_1 WHERE REPORT_1.Q26_IS_VAT_REGISTERED = '2' 
					AND REPORT_1.GEO_CODE_UNION_ID = REPORT.GEO_CODE_UNION_ID) VAT_NOT_REGISTERED 
					FROM BBSEC2013_REPORTS REPORT 
					WHERE" .$where.
					"GROUP BY REPORT.GEO_CODE_UNION_ID, REPORT.UNION_NAME
					ORDER BY REPORT.UNION_NAME";
