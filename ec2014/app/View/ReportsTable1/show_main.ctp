...
<table border="1" style="border-collapse:collapse;border:none; text-align : center; width:100%;" id="tblExport">
 ...
 <tr>
      <td rowspan = "2"><strong>BSIC Code (4 digit)</strong></td>
      <td rowspan = "2"><strong>Location, economic activity and type of units</strong></td>
      <td rowspan = "2"><strong>Number of unite</strong></td>
...
<tr>
  <td colspan = "2"><strong>Zila: <?= $this->request->data['zila_text'];  ?></strong></td>
  <td colspan = "13"> </td>
  <td><strong> </strong></td>
</tr>
