...
<?php echo $this->Form->create('ProdCodeClass'); ?>
	<fieldset>
		<legend><?php echo __('Edit Prod Code Class'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ProdCodeClass.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ProdCodeClass.id'))); ?></li>
