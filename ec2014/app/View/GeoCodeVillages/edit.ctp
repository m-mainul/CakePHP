...
<div class="geoCodeVillages form">
	...
	<fieldset>
		<legend>
			<?php echo __('Edit Village'); ?>
		</legend>
		<?php echo $this -> Form -> input('id');

		$options = array($this -> request -> data['GeoCodeMauza']['id'] => $this -> request -> data['GeoCodeMauza']['mauza_name']);
		...
		echo $this -> Form -> input('muza_id', array('label' => 'মৌজা  নাম', 'options' => $options,'required' => 'required'));
...
<div class="actions">
	...
	<ul>
		...
		<li>
			<?php echo $this -> Form -> postLink(__('Delete'), array('action' => 'delete', $this -> Form -> value('GeoCodeVillage.id')), null, __('Are you sure you want to delete # %s?', $this -> Form -> value('GeoCodeVillage.id'))); ?>
		</li>
		<li>
			<?php echo $this -> Html -> link(__('List Villages'), array('action' => 'index')); ?>
		</li>
