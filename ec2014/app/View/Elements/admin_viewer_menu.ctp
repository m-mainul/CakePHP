...
<!-- 	 <div class="logo"> 
	...
	<div id="templatemo_menu">
		...
		<ul>
            ...
            <li>
                <?php echo $this -> Html -> link('প্রশ্নপত্র দেখুন',array('plugin' => '', 'controller' => 'Pages', 'action' => 'search_ques'), array('class' => $_SESSION["MenuActive"] == 9 ? 'current' : "")); ?>
            </li>

            <li>
                <?php echo $this -> Html -> link('বই দেখুন',array('plugin' => '', 'controller' => 'Pages', 'action' => 'search_book'), array('class' => $_SESSION["MenuActive"] == 10 ? 'current' : "")); ?>
            </li>
