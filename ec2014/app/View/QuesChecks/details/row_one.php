		...
		<div id="div_3">
			...
			<table style="margin: 0px">
				...
				<tr>
					...
					<br />
					<br />
					<?php echo $this -> Form -> input('q3_unit_head_gender', array('style' => 'width: 80px; text-align:center;', 'label' => false, 'readonly' => 'readonly', 'value' => $questionaires[0]['Questionaire']['q3_unit_head_gender'])); ?></td>
...
'maxlength' => 2, 'minlength' => 2))
		...
		<div id="div_4">
			...
			<hr />
			<br />
			<?php echo $this -> Form -> input('q4_unit_type', array('div' => true, 'readonly' => 'readonly', 'value' => $questionaires[0]['Questionaire']['q4_unit_type'], 'style' => 'width: 85px; text-align:center;', 'required' => 'required', 'label' => false)); ?>
			<br/>
			...
			<div id = "div_4_1" >
				...
				<?php echo $this -> Form -> input('q4_unit_org_type', array('div' => true, 'readonly' => 'readonly', 'style' => 'width: 85px; text-align:center;', 'label' => false, 'value' => $questionaires[0]['Questionaire']['q4_unit_org_type'])); ?>
			</div>
		</div></td>
...
'type' => 'textarea', ))
			...
			<?=$this -> Form -> input('q6_economy_id', array('label' => false, 'readonly' => 'readonly', 'value' => $questionaires[0]['Questionaire']['q6_ind_code_class_id'], 'style' => 'width: 65px; text-align:center;', 'maxlength' => 4, 'minlength' => 4, 'type' => 'text')) ?>
		</div></td>
