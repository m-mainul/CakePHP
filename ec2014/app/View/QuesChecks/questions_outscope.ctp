...
<div id="new_book">
    <?php echo $this -> Html -> link(__('BACK TO BOOKS'), array('controller' => 'QuesChecks', 'action' => 'books_outscope', $book['geo_code_union_id'], $book['geo_code_upazila_id'])); ?>
</div>
<br />
...
foreach ($questionaires as $questionaire): ++$i;
        ...
        <tr>
            ...
            <td><?php echo $this->html->link('Details', array('controller' => 'QuesChecks', 'action' => 'details_outscope', $questionaire['Questionaire']['id']))
            ?></td>
        </tr>
        <?php endforeach;
        ?>
