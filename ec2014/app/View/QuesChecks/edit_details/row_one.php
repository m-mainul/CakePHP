		...
		<div id="div_2">
			...
			<table width="350px" input[type=text]{text-transform: uppercase;}>
				...
				<tr>
					...
					$options = array($questionaires[0]['Questionaire']['q2_village_maholla'] => $questionaires[0]['Questionaire']['q2_village_maholla']);
					/*
					if($this->Session->check('village_options'))
										{*/
					
						echo $this -> Form -> input('q2_village_maholla', array(
						'label' => false, 
						'required' => 'required',
						'options' => $options,
				...
				<tr>
					...
					'label' => false,
					'type' => 'email',
					'value' => $questionaires[0]['Questionaire']['q2_email_address'])) ?> </td>
				</tr>
		...
		<div id="div_3">
			...
			<table style="margin: 0px">
				...
				<tr>
					...
					'options' => array('' => '', '1' => '1-পুরুষ', '2' => '2-মহিলা', '3' => '3-অন্যান্য'))); 
					?>
					</td>
...
<!-- SECTION 4 START  -->
		...
		<div id="div_4">
			...
			'required'=>'required', 
			'label' => false, 
			'options' => array('' => '', '1' => '1-খানা', '2' => '2-প্রতিষ্ঠান'))); ?>
			<br/>
			...
			<div id = "div_4_1" >
				...
				'options' => array('' => '', '1' => '1-স্থায়ী', '2' => '2-অস্থায়ী'))); ?>
			</div>
		</div></td>
