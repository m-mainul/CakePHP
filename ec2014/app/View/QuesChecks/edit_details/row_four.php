			...
			<tr>
				...
				<div id="div_18">
            		...
            		<?=$this -> Form -> input('q18_machine_uses', array(
            			'label' => false,
            			'value' => $questionaires[0]['Questionaire']['q18_machine_uses'],
            			'type' => 'text',
				...
				<div id="div_19">
            		...
            		<?=$this -> Form -> input('q19_marketing', array(
            			'label' => false,
            			'value' => $questionaires[0]['Questionaire']['q19_marketing'],
            			'type' => 'text',
            			'style'=>'width: 50px;text-align:center;',
            			'maxlength'=>1,
            			'minlength' =>1 ))
				...
				<div id="div_20">
            		...
            		<?=$this -> Form -> input('q20_fuel_uses', array(
            			'label' => false,
            			'value' => $questionaires[0]['Questionaire']['q20_fuel_uses'],
            			'type' => 'text',
            			'style'=>'width: 50px;text-align:center;',
            			'maxlength'=>1,
            			'minlength' =>1 ))
				...
				<div id="div_21">
					...
					<?=$this -> Form -> input('q21_is_it_enabled', array(
            			'label' => false,
            			'value' => $questionaires[0]['Questionaire']['q21_is_it_enabled'],
            			'type' => 'text',
            			'style'=>'width: 50px;text-align:center;',
            			'maxlength'=>1,
            			'minlength' =>1 ))
				...
				<div id="div_22">
					...
					<?=$this -> Form -> input('q22_is_fire_secured', array(
            			'label' => false,
            			'value' => $questionaires[0]['Questionaire']['q22_is_fire_secured'],
            			'type' => 'text',
            			'style'=>'width: 50px;text-align:center;',
            			'maxlength'=>1,
            			'minlength' =>1 ))
				...
				<div id="div_22_1">
					...
					<?=$this -> Form -> input('q22_is_fire_device_maintained', array(
            			'label' => false,
            			'value' => $questionaires[0]['Questionaire']['q22_is_fire_device_maintained'],
            			'type' => 'text',
            			'style'=>'width: 50px;text-align:center;',
            			'maxlength'=>1,
            			'minlength' =>1 ))
				...
				<div id="div_23">
					...
					<?=$this -> Form -> input('q23_is_garbage_proper', array(
            			'label' => false,
            			'value' => $questionaires[0]['Questionaire']['q23_is_garbage_proper'],
            			'type' => 'text',
            			'style'=>'width: 50px;text-align:center;',
            			'maxlength'=>1,
            			'minlength' =>1 ))
				...
				<div id="div_24">
					...
					<?=$this -> Form -> input('q24_is_toilet_available', array(
            			'label' => false,
            			'value' => $questionaires[0]['Questionaire']['q24_is_toilet_available'],
            			'type' => 'text',
            			'style'=>'width: 50px;text-align:center;',
            			'maxlength'=>1,
            			'minlength' =>1 ))
				...
				<div id="div_24_1">
					...
					<?=$this -> Form -> input('q24_is_ladies_toilet_available', array(
            			'label' => false,
            			'value' => $questionaires[0]['Questionaire']['q24_is_ladies_toilet_available'],
            			'type' => 'text',
            			'style'=>'width: 50px;text-align:center;',
            			'maxlength'=>1,
            			'minlength' =>1 ))
				...
				<div id="div_25">
					...
					<?=$this -> Form -> input('q25_is_tin_registered', array(
            			'label' => false,
            			'value' => $questionaires[0]['Questionaire']['q25_is_tin_registered'],
            			'type' => 'text',
            			'style'=>'width: 50px;text-align:center;',
            			'maxlength'=>1,
            			'minlength' =>1 ))
				...
				<div id="div_26">
					...
					<?=$this -> Form -> input('q26_is_vat_registered', array(
            			'label' => false,
            			'value' => $questionaires[0]['Questionaire']['q26_is_vat_registered'],
            			'type' => 'text',
            			'style'=>'width: 50px;text-align:center;',
            			'maxlength'=>1,
            			'minlength' =>1 ))
				...
				<div id="div_27">
					...
					'label' => FALSE,
					'value' => $questionaires[0]['Questionaire']['q27_year_vat_registered'],
					'type' => 'text',
