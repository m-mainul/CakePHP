...
$TOTAL_OF_EST = (int)$result_A['TOTAL_EST']+ 
(int)$result_B['TOTAL_EST']+
(int)$result_C['TOTAL_EST']+
(int)$result_D['TOTAL_EST']+
(int)$result_E['TOTAL_EST']+
(int)$result_F['TOTAL_EST']+
(int)$result_G['TOTAL_EST']+
(int)$result_H['TOTAL_EST']+
(int)$result_I['TOTAL_EST']+
(int)$result_J['TOTAL_EST']+
(int)$result_K['TOTAL_EST']+
(int)$result_L['TOTAL_EST']+
(int)$result_M['TOTAL_EST']+
(int)$result_N['TOTAL_EST']+
(int)$result_O['TOTAL_EST']+
(int)$result_P['TOTAL_EST']+
(int)$result_Q['TOTAL_EST']+
(int)$result_R['TOTAL_EST']+
(int)$result_S['TOTAL_EST']+
(int)$result_T['TOTAL_EST']+
(int)$result_U['TOTAL_EST'] ;

$TOTAL_OF_F_A_1 = (int)$result_A['F_A_1']+ 
(int)$result_B['F_A_1']+
(int)$result_C['F_A_1']+
(int)$result_D['F_A_1']+
(int)$result_E['F_A_1']+
...
$TOTAL_OF_F_A_2 = (int)$result_A['F_A_2']+ 
(int)$result_B['F_A_2']+
(int)$result_C['F_A_2']+
(int)$result_D['F_A_2']+
(int)$result_E['F_A_2']+
...
$TOTAL_OF_F_A_3 = (int)$result_A['F_A_3']+ 
(int)$result_B['F_A_3']+
(int)$result_C['F_A_3']+
(int)$result_D['F_A_3']+
(int)$result_E['F_A_3']+
...
$TOTAL_OF_F_A_4 = (int)$result_A['F_A_4']+ 
(int)$result_B['F_A_4']+
(int)$result_C['F_A_4']+
(int)$result_D['F_A_4']+
(int)$result_E['F_A_4']+
...
$TOTAL_OF_F_A_5 = (int)$result_A['F_A_5']+ 
(int)$result_B['F_A_5']+
(int)$result_C['F_A_5']+
(int)$result_D['F_A_5']+
(int)$result_E['F_A_5']+
...
$TOTAL_OF_F_A_6 = (int)$result_A['F_A_6']+ 
(int)$result_B['F_A_6']+
(int)$result_C['F_A_6']+
(int)$result_D['F_A_6']+
(int)$result_E['F_A_6']+
...
$TOTAL_OF_F_A_7 = (int)$result_A['F_A_7']+ 
(int)$result_B['F_A_7']+
(int)$result_C['F_A_7']+
(int)$result_D['F_A_7']+
(int)$result_E['F_A_7']+
...
(int)$result_U['F_A_7'] ;
 ...
 ?>
 <tr>
    <td colspan="10"><b>Table 6.1: Establishments by economic activity and size of current fixed assets in 2013</b></td>
  </tr>
 <tr >
  <td rowspan=2 >Code</td>
  <td rowspan=2 >Economic activity</td>
  <td rowspan=2 >Establishments</td>
  <td colspan=7 >Fixed assets (in lac Taka)</td>
 </tr>
 <tr >
  <td >Up to 5</td>
  <td >5-50</td>
...
<tr>
  ...
  <td><?= $TOTAL_OF_EST  ;?></td>
  <td><?= $TOTAL_OF_F_A_1 ;?></td>
  <td><?= $TOTAL_OF_F_A_2 ;?></td>
  <td><?= $TOTAL_OF_F_A_3 ;?></td>
  <td><?= $TOTAL_OF_F_A_4 ;?></td>
  <td><?= $TOTAL_OF_F_A_5 ;?></td>
  <td><?= $TOTAL_OF_F_A_6 ;?></td>
  <td><?= $TOTAL_OF_F_A_7 ;?></td>
 </tr>
