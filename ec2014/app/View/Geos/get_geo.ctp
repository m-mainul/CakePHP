...
<fieldset>
	...
	<?php echo $this -> Form -> input('geo_code_divn_id', array('empty' => '', 'options' => $divns, 'label' => 'বিভাগ')); ?>
	<div id="BookGeoCodeDivnName" class="message"></div>

	<?php echo $this -> Form -> input('geo_code_zila_id', array('empty' => '', 'label' => 'জেলা')); ?>

	<div id="BookGeoCodeZilaName" class="message"></div>

	<?php echo $this -> Form -> input('geo_code_upazila_id', array('empty' => '', 'label' => 'উপজেলা/থানা')); ?>

	<div id="BookGeoCodeUpazilaName" class="message"></div>

	<!--<div id="BookGeoCodeRmaName" class="message"></div>-->

	<?php echo $this -> Form -> input('geo_code_psa_id', array('empty' => '', 'label' => 'পৌরসভা/সিটি কর্পোরেশন')); ?>

	<div id="BookGeoCodePsaName" class="message"></div>

	<?php echo $this -> Form -> input('geo_code_union_id', array('empty' => '', 'label' => 'ইউনিয়ন/ওয়ার্ড')); ?>

	<div id="BookGeoCodeUnionName" class="message"></div>

	<?php echo $this -> Form -> input('geo_code_mauza_id', array('empty' => '', 'label' => 'মৌজা')); ?>
	<div id="BookGeoCodeMauzaName" class="message"></div>

	<?php

	echo $this -> Form -> input('geo_code_village_id', array('empty' => '', 'label' => 'গ্রাম'));
	?>
