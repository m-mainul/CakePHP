...
<?php echo $this->Form->create('GeoCodeUnion'); ?>
	...
	<?php
		...
		echo $this->Form->input('divns', array('empty' => '','label' => 'বিভাগ', 'options' => $divns,'required' => 'required')); 
        echo $this->Form->input('geo_code_zila_id', array('empty' => '', 'label' => 'জেলা','required' => 'required'));
       
		echo $this->Form->input('geo_code_upazila_id', array('empty' => '','label' => 'উপজেলা ','options' => $options,'required' => 'required', 'value' => ''));
