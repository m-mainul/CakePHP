...
<?php 
  ...
  $total_person_4 = 0;
  $total_person_5_9 = 0;
  $total_person_10_19 = 0;
  $total_person_20_49 = 0;
  $total_person_50_99 = 0;
  $total_person_100_199 = 0;
  $total_person_200 = 0;
 ?>
...
<?php 
  ...
  if ($res['number_of_unit'] != 0 )
     { 
      ...
      <?php  
          $estabTotal += $res['number_of_unit'];
          $tpeTotal +=  $res['total_person_engaged'];
          $total_unit_1 += $res['total_unit_1'];
          $total_unit_2 += $res['total_unit_2'];
          $total_unit_3 += $res['total_unit_3'];
          $total_unit_4 += $res['total_unit_4'];
          $total_unit_5_9 += $res['total_unit_5_9'];
          $total_unit_10_19 += $res['total_unit_10_19'];
          $total_unit_20_49 += $res['total_unit_20_49'];
          $total_unit_50_99 += $res['total_unit_50_99'];
          $total_unit_100_199 += $res['total_unit_100_199'];
          $total_unit_200 += $res['total_unit_200'];

          $total_person_1 += $res['total_person_1'];
          $total_person_2 += $res['total_person_2'];
          $total_person_3 += $res['total_person_3'];
          $total_person_4 += $res['total_person_4'];
          $total_person_5_9 += $res['total_person_5_9'];
          $total_person_10_19 += $res['total_person_10_19'];
          $total_person_20_49 += $res['total_person_20_49'];
          $total_person_50_99 += $res['total_person_50_99'];
          $total_person_100_199 += $res['total_person_100_199'];
          $total_person_200 += $res['total_person_200'];
      ?>
...
<tr>
      <td align="left" rowspan = "2" colspan="2" style="text-align:center"><strong style="text-align:center;">Total</strong></td>
      

      <td>Estab.</td>
      <td><?php echo $estabTotal; ?></td>
      <td><?= $total_unit_1; ?></td>
      <td><?= $total_unit_2; ?></td>
      <td><?= $total_unit_3; ?></td>
      <td><?= $total_unit_4; ?></td>
      <td><?= $total_unit_5_9; ?></td>
      <td><?= $total_unit_10_19; ?></td> 
      <td><?= $total_unit_20_49; ?></td>
      <td><?= $total_unit_50_99; ?></td>
      <td><?= $total_unit_100_199; ?></td>
      <td><?= $total_unit_200; ?></td>
     
</tr>

<tr>
   <td>Persons</td>
   <td><?php echo $tpeTotal;?></td>
   <td><?= $total_person_1; ?></td>
   <td><?= $total_person_2; ?></td>
   <td><?= $total_person_3; ?></td>
   <td><?= $total_person_4; ?></td>
   <td><?= $total_person_5_9; ?></td>
   <td><?= $total_person_10_19; ?></td>
   <td><?= $total_person_20_49; ?></td>
   <td><?= $total_person_50_99; ?></td>
   <td><?= $total_person_100_199; ?></td>
   <td><?= $total_person_200; ?></td>
