...
<div id="new_book">
	<?php echo $this -> Html -> link(__('BACK TO BOOKS'), array('controller' => 'QuesSixChecks', 'action' => 'sobooks', $secQuestions[0]['Book']['geo_code_union_id'])); ?>
</div>
<br />
...
foreach ($questionaires as $questionaire):
		...
		<tr>
			...
			<td style="font-weight: bold;"><?php echo h($questionaire['QuesSixCheck']['approve_status']); ?>&nbsp;</td>
