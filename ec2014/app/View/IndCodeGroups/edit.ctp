<div class="indCodeGroups form">
	...
	<fieldset>
		<legend>
			<?php echo __('Edit Ind Code Group'); ?>
		</legend>
...
<div class="actions">
	...
	<ul>
		...
		<li>
			<?php echo $this -> Form -> postLink(__('Delete'), array('action' => 'delete', $this -> Form -> value('IndCodeGroup.id')), null, __('Are you sure you want to delete # %s?', $this -> Form -> value('IndCodeGroup.id'))); ?>
		</li>
		<li>
