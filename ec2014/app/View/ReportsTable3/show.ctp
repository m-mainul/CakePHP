...
<?php
      ...
      $cottage_est += $res['cottage_est'];
      $micro_est += $res['micro_est'];
      $small_est += $res['small_est'];
      $medium_est += $res['medium_est'];
      $large_est += $res['large_est'];

      $total_person += $res['total_person'];
      $cottage_person += $res['cottage_person'];
      $micro_person += $res['micro_person'];
      $small_person += $res['small_person'];
      $medium_person += $res['medium_person'];
      $large_person += $res['large_person'];
...
<tr>
    <td align="left" rowspan = "2" colspan="2"><strong>Total</strong></td>
