...
<?php 
    ...
    $TOTAL_PERSON += (int)$res['TOTAL_PERSON'];
    $FIRE_FIGHTING += (int)$res['FIRE_FIGHTING'];
    $WASTE_MANAGEMENT += (int)$res['WASTE_MANAGEMENT'];
    $TOILET_FACILITY += (int)$res['TOILET_FACILITY'];
    $FEMALE_TOILET += (int)$res['FEMALE_TOILET'];
?>
...
<?php } 
   ...
   <tr>
     <td align="left" colspan="2" style="text-align: center"><strong>Zila Total</strong></td>
     <td><?=$TOTAL_EST ?></td>
     <td><?=$TOTAL_PERSON ?></td>
     <td><?=$FIRE_FIGHTING ?></td>
     <td><?=$WASTE_MANAGEMENT ?></td>
     <td><?=$TOILET_FACILITY ?></td>
     <td><?=$FEMALE_TOILET ?></td>
   </tr>
