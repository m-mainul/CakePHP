...
<fieldset>
	...
	echo $this -> Form -> input('geo_code_divn_id', array('empty' => '', 'options' => $divns, 'label' => 'বিভাগ', 'value' => $old_geo_code_divn_id));
	...
	echo $this -> Form -> input('geo_code_psa_id', array('empty' => '', 'label' => 'পৌরসভা/সিটি কর্পোরেশন'));
	echo $this -> Form -> input('geo_code_union_id', array('empty' => '', 'label' => 'ইউনিয়ন/ওয়ার্ড'));
	echo $this -> Form -> input('book_id', array('empty' => '', 'label' => 'বই নং'));

	echo $this -> Form -> input('geo_code_mauza_id', array('empty' => '', 'label' => 'মৌজা'));
