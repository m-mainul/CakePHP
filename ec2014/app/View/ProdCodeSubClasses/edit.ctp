...
<?php echo $this->Form->create('ProdCodeSubClass'); ?>
	<fieldset>
		<legend><?php echo __('Edit Prod Code Sub Class'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ProdCodeSubClass.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ProdCodeSubClass.id'))); ?></li>
