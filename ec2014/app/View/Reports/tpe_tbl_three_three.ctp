...
<div id="table_for_print">
 ...
 <table border="1" style="border-collapse:collapse;border:none; text-align : center; width:100%;" id="tblExport">
        <tr>
          <td colspan="7"><b>Table 3.3: Total Persons Engaged (TPE) by Sex, Type of Establishment and Location in 2001 & 03 and in 2013</b></td>
        </tr>
        <tr>
...
$total_urban_est_male = $total_urban_parmanent_est_male + $total_urban_temporary_est_male + $total_urban_household_est_male;
$total_urban_est_female = $total_urban_parmanent_est_female + $total_urban_temporary_est_female + $total_urban_household_est_female;
...
$total_rural_est_male = $total_rural_parmanent_est_male + $total_rural_temporary_est_male + $total_rural_household_est_male;
$total_rural_est_female = $total_rural_parmanent_est_female + $total_rural_temporary_est_female + $total_rural_household_est_female;
...
<tr>
 ...
 <tr>  <!-- Temporary -->
  ...
  <td><?=$total_temporary_est_male; ?></td>
  <td><?=$total_temporary_est_female; ?></td>
 ...
 <tr> <!-- Household -->
  ...
  <td><?=$total_household_est_male; ?></td>
  <td><?=$total_household_est_female; ?></td>
...
<!-- TWO -->
 ...
 <tr>
  ...
  <td><?=$total_urban_est_male; ?></td>
  <td><?=$total_urban_est_female; ?></td>
 ...
 <tr>  <!-- Permanent -->
  ...
  <td><?=$total_urban_parmanent_est_male; ?></td>
  <td><?=$total_urban_parmanent_est_female; ?></td>
 ...
 <tr>  <!-- Temporary -->
  ...
  <td> <?=$total_urban_temporary_est_male; ?></td>
  <td> <?=$total_urban_temporary_est_female; ?></td>
 ...
 <tr> <!-- Household -->
  ...
  <td> <?=$total_urban_household_est_male; ?></td>
  <td> <?=$total_urban_household_est_female; ?></td>
...
<!-- THREE RURAL-->
 <tr>
  ...
  <td><?=$total_rural_est_male; ?></td>
  <td><?=$total_rural_est_female; ?></td>
 ...
 <tr>  <!-- Permanent -->
  ...
  <td><?=$total_rural_parmanent_est_male; ?></td>
  <td><?=$total_rural_parmanent_est_female; ?></td>
 ...
 <tr>  <!-- Temporary -->
  ...
  <td><?=$total_rural_temporary_est_male; ?></td>
  <td><?=$total_rural_temporary_est_female; ?></td>
 ...
 <tr> <!-- Household -->
  ...
  <td> <?=$total_rural_household_est_male; ?></td>
  <td> <?=$total_rural_household_est_female; ?></td>
