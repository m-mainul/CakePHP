...
<table border="1" style="border-collapse:collapse;border:none; text-align : center; width:100%;" id="tblExport" >
 <tr>
          <td colspan="7"><b>Table 4.1: Number of Establishment and Total Persons Engaged (TPE) by Sex and Economic Activity and Average Size of Establishment in 2013.</b></td>
        </tr>
 <tr >
...
<tr>
 ...
 <?php 
      ...
      // $Total_Estab =  $B_Total_Estab + $C_Total_Estab + $D_Total_Estab  + $E_Total_Estab + $F_Total_Estab   + $G_Total_Estab  + $H_Total_Estab              + $I_Total_Estab  + $J_Total_Estab  + $K_Total_Estab  + $L_Total_Estab + $M_Total_Estab  + $N_Total_Estab + 
      //                   $O_Total_Estab + $P_Total_Estab  + $Q_Total_Estab   + $R_Total_Estab + $S_Total_Estab + $T_Total_Estab  + 
      //                   $U_Total_Estab;
...
<br><div class="notice"> 
<p>
  Total establishments and persons engaged by sex and activity are portrayed in table 4.1. It is seen from the table above, there is a total of 118487 establishments with 323951 total persons engaged in Comilla zila. Of total 323951 persons engaged, 307397 are male and 16554 female i.e. and overwhelming 94.9% are males and 5.1% females. Wholesale and retail trade emerges as the single largest activity (59.3%) with 70205 establishments and 152583 persons (47.1%) followed by community, social and personal services with 15730 establishments and 152583 persons (47.1%) followed by community, social and personal services with 15730 establishments and 34252 persons engaged, hotels and restaurants with 11035 establishments and 29291 persons engaged and manufacturing with 8245 establishments and 47162 persons engaged. Of the 16554 female persons engaged and manufacturing with 8245 establishments and 474162 persons engaged. Of the 16554 female persons who work in nonfarm economic activities in Comilla, education alone engages 5277 female persons followed by wholesale and retail trade (3051) and manufacturing (2666). Other categories of nonfarm economic activities engaging large number of female are community, social and personal service (1575) health and social work (1330), hotels and restaurants (996), bank, insurance and financial institution (887) and public administration and defence (305).
</p>


<p>Leaving aside mining & quarrying where there is only three establishment engaging 80.7 persons per establishment, electricity, gas and water supply has the highest number of 18.2 persons engaged per establishment followed by construction (15.3), public administration and defence (10.1), bank, insurance and financial institution (8.8), manufacturing (5.7) , education (4.8) and health and social work (3.6) which are higher than the average establishment size of 2.7 persons in Comilla zila. The average establishment size of the activity hotels and restaurants is equal to zila average. The remaining sectors of establishments have lower than 2.7 persons engaged per establishment.</p>
