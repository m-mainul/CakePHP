...
'maxlength'=>2,'minlength' =>2))
					...
					মহিলা
					<br />
					<?=$this -> Form -> input('q17_hr_female_irregular', array('label' => FALSE, 'value' => $questionaires[0]['Questionaire']['q17_hr_female_irregular'], 'type' => 'text', 'style' => 'width: 50px; text-align:center;', 'required' => 'required', 'maxlength' => 2, 'minlength' => 2)) ?></td>
