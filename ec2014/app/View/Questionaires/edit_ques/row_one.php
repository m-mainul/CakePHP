...
'style' => 'text-transform: uppercase'))
				...
				<tr>
					...
					<td><?php $options = array($questionaires[0]['Questionaire']['q2_village_maholla'] => $questionaires[0]['Questionaire']['q2_village_maholla']);
					/*
					 if($this->Session->check('village_options'))
					 {*/

					echo $this -> Form -> input('q2_village_maholla', array('label' => false, 'required' => 'required', 'options' => $options, 'style' => 'text-transform: uppercase'));
					?></td>
				</tr>
		...
		<div id="div_3">
			...
			<table style="margin: 0px">
				...
				<tr>
					...
					<br />
					<br />
					<?php echo $this -> Form -> input('q3_unit_head_gender', array('style' => 'width: 80px', 'label' => false, 'value' => $questionaires[0]['Questionaire']['q3_unit_head_gender'], 'options' => array('' => '', '1' => '1-পুরুষ', '2' => '2-মহিলা', '3' => '3-অন্যান্য'))); ?></td>
...
'minlength' => 2, 'type' => 'text'))
					?>
					<div id="q3unitheadheducation">
<?php echo  $edu_code[0]['UnitHeadEducation']['education_desc_bng'];?></div></td>
...
'maxlength' => 2, 'minlength' => 2))
		...
		<div id="div_4">
			...
			<hr />
			<br />
			<?php echo $this -> Form -> input('q4_unit_type', array('div' => true, 'value' => $questionaires[0]['Questionaire']['q4_unit_type'], 'style' => 'width: 85px', 'required' => 'required', 'label' => false, 'options' => array('' => '', '1' => '1-খানা', '2' => '2-প্রতিষ্ঠান'))); ?>
			<br/>
			...
			<div id = "div_4_1" >
				...
				<?php echo $this -> Form -> input('q4_unit_org_type', array('div' => true, 'style' => 'width: 85px', 'label' => false, 'value' => $questionaires[0]['Questionaire']['q4_unit_org_type'], 'options' => array('' => '', '1' => '1-স্থায়ী', '2' => '2-অস্থায়ী'))); ?>
			</div>
		</div></td>
...
'type' => 'textarea', ))
			...
			<?=$this -> Form -> input('q6_economy_id', array('label' => false, 'value' => $questionaires[0]['Questionaire']['q6_ind_code_class_id'], 'style' => 'width: 65px; text-align:center;', 'maxlength' => 4, 'minlength' => 4, 'type' => 'text')) ?>
		</div></td>
