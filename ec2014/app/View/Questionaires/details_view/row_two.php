...
'style'=>'text-align:center;'
					...
					<div id="QuestionaireQ7ProductDesc1div" class="div_seven_message">
						<?=$questionaires[0]['Questionaire']['q7_product_desc_1']
						?>
					</div></td>
...
'style'=>'text-align:center;'))
					...
					<div id="QuestionaireQ7ProductDesc2div" class="div_seven_message">
						<?=$questionaires[0]['Questionaire']['q7_product_desc_2']
						?>
					</div></td>
				</tr>
...
'style'=>'text-align:center;'))
					...
					<div id="QuestionaireQ7ProductDesc3div" class="div_seven_message">
						<?=$questionaires[0]['Questionaire']['q7_product_desc_3']
						?>
					</div></td>
				</tr>
...
'style'=>'text-align:center;'))
					...
					<div id="QuestionaireQ7ProductDesc4div" class="div_seven_message">
						<?=$questionaires[0]['Questionaire']['q7_product_desc_4']
						?>
					</div></td>
				</tr>
...
'style'=>'text-align:center;'))
					...
					<div id="QuestionaireQ8ServiceDesc1div" class="div_seven_message">
						<?=$questionaires[0]['Questionaire']['q8_service_desc_1']
						?>
					</div></td>
				</tr>
...
'style'=>'text-align:center;'))
					...
					<div id="QuestionaireQ8ServiceDesc2div" class="div_seven_message">
						<?=$questionaires[0]['Questionaire']['q8_service_desc_2']
						?>
					</div></td>
				</tr>
...
'style'=>'text-align:center;'))
					...
					<div id="QuestionaireQ8ServiceDesc4div" class="div_seven_message">
						<?=$questionaires[0]['Questionaire']['q8_service_desc_4']
						?>
					</div></td>
				</tr>
		...
		<div id = "div_10">
			...
			<table id = 'tbl_10_1' border = '1'>
				...
				<tr>
					...
					<?php echo $this -> Form -> input('q10_is_nbr_investment', array('label' => false, 'value' => $questionaires[0]['Questionaire']['q10_is_nbr_investment'], 'type' => 'text', 'readonly' => 'readonly', 'style' => 'width: 65px; text-align:center;')); ?>
...
'style'=>'width: 65px; text-align:center;'))
			...
			<tr>
				...
				<div id = "div_11_1">
					...
					<hr />
					<label>(কোড লিখুন)</label>
					<?=$this -> Form -> input('q11_registrar_id', array('label' => false, 'value' => $questionaires[0]['Questionaire']['q11_registrar_id'], 'readonly' => 'readonly', 'type' => 'text', 'style' => 'width: 65px; text-align:center;')) ?>
