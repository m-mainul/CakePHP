...
<div class="geoCodeMauzas form">
	...
	<fieldset>
		...
		echo $this -> Form -> input('divns', array('empty' => '','label' => 'বিভাগ', 'options' => $geoCodeDivns,'required' => 'required'));
		...
		echo $this -> Form -> input('geo_code_union_id', array('label' => 'ইউনিয়ন/ওয়ার্ড', 'options' => $options,'required' => 'required'));
		...
		echo $this -> Form -> input('geo_code_rmo_id', array('label' => 'আর এম ও','required' => 'required'));
		?>
	</fieldset>
