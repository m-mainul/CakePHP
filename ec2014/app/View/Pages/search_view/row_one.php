...
<td width="250px">
<div id="div_1">
<h3>১. মৌজা/মহল্লার নাম ও কোড</h3><hr />

<label>নাম:</label>
<?=$this -> Form -> input('q1_geo_code_mauza_name', array(
'label' => false,
'style' => 'text-align: center;',
'value' => $questionaires['Questionaire']['q1_geo_code_mauza_name'],
'readonly' => 'readonly'))?>
...
'label' => false,
'type' => 'text',
'value' => $questionaires['GeoCodeMauza']['mauza_code'],
...
'label' => FALSE,
'type' => 'text',
'value' => $questionaires['Questionaire']['q1_unit_serial_no'],
'style' => 'width: 65px; text-align:center;',
'required' => 'required',
'readonly' => 'readonly',
'maxlength' => 3,
...
<td width="350px">
<div id="div_2"><h3>২. ইউনিটের নাম ও ঠিকানা (ইংরেজিতে লিখুন)</h3><hr />
...
'label' => FALSE,
'readonly' => 'readonly',
'value' => $questionaires['Questionaire']['q2_unit_name'],
'required' => 'required',
...
'label' => false,
'value' => $questionaires['Questionaire']['q2_village_maholla'],
'type' => 'text',
'readonly' => 'readonly',
'required' => 'required',
'style' => 'text-transform: uppercase; text-align:center;'))?></td>
...
'label' => false,
'readonly' => 'readonly',
'value' => $questionaires['Questionaire']['q2_home_market'],
'style' => 'text-transform: uppercase; text-align:center;'))?></td>
</tr>
				<!--  -->
...
'label' => false,
'readonly' => 'readonly',
'value' => $questionaires ['Questionaire']['q2_road_no_name'],
'style' => 'text-transform: uppercase; text-align:center;'))?></td>
</tr>
				<?php //endif; ?>
				<!--  -->
...
'label' => false,
'readonly' => 'readonly',
'value' => $questionaires ['Questionaire']['q2_holding_no'],
'style' => 'text-transform: uppercase; text-align:center;'))?></td>
</tr>
...
'label' => false,
'readonly' => 'readonly',
'value' => $questionaires ['Questionaire']['q2_telephone_no'],
'style' => 'text-transform: uppercase; text-align:center;'))?></td>
</tr>
...
'label' => false,
'readonly' => 'readonly',
'value' => $questionaires ['Questionaire']['q2_fax_no'],
'style' => 'text-transform: uppercase; text-align:center;'))?></td>
</tr
...
'label' => false,
'readonly' => 'readonly',
'value' => $questionaires ['Questionaire']['q2_email_address'],
'style' => 'text-transform: uppercase; text-align:center;'))?></td>
</tr>
...
<tr>
<td width="200"  height="186" style="border-right: 1px solid;"><br />পুরুষ...1<br />মহিলা...2<br />অন্যান্য...3<br /><br />
<?php echo $this -> Form -> input('q3_unit_head_gender', array(
'style' => 'width: 80px; text-align:center;', 
'label' => false, 'readonly' => 'readonly', 
'value' => $questionaires ['Questionaire']['q3_unit_head_gender'])); ?></td>

<td width="200"  style="border-right: 1px solid;"><br />(শিক্ষা কোড<br />লিখুন)<br /><br /><br />
<?=$this -> Form -> input('q3_unit_head_education_id', array(
'label' => false,
'readonly' => 'readonly',
'value' => $edu_code ['UnitHeadEducation']['education_code'],
'style' => 'width: 65px; text-align:center;',
'maxlength' => 2,
'minlength' => 2, 'type' => 'text'))?>
<div id="q3unitheadheducation"> <?php echo  $edu_code ['UnitHeadEducation']['education_desc_bng'];?></div></td>



<td width="200"><br />(পূর্ণ বছরে<br/>লিখুন)<br /><br /><br />
<?=$this -> Form -> input('q3_unit_head_age', array(
'label' => false,
'readonly' => 'readonly',
'value' => $questionaires ['Questionaire']['q3_unit_head_age'],
'type' => 'text',
'style' => 'width: 65px; text-align:center;',
...
<td width="200px">
<div id="div_4">
<h3>৪. ইউনিটের প্রকার</h3><hr />
<label><span id="redmark">*</span>ইউনিটের প্রকার</label><hr /><br />
<?php echo $this -> Form -> input('q4unittype', array(
'div' => true, 'readonly' => 'readonly', 
'style' => 'width: 85px; text-align:center;',
'value' => $questionaires['Questionaire']['q4_unit_type'],  
'required' => 'required', 
'label' => false)); ?><br/>
...
<?php echo $this -> Form -> input('q4unitorgtype', array(
'div' => true, 'readonly' => 'readonly', 
'style' => 'width: 85px; text-align:center;', 
'label' => false, 
'value' => $questionaires['Questionaire']['q4_unit_org_type'])); ?>
</div>
</div></td>
...
<h3>৫. ইউনিটের প্রধান অর্থনৈতিক কর্মকাণ্ডের প্রকার</h3><hr />
<label>(কোড লিখুন)</label>
<?=$this -> Form -> input('q5_unit_head_economy_id', array(
'label' => false,
'readonly' => 'readonly',
'value' => $questionaires ['UnitHeadEconomy']['economy_code'],
'style' => 'width: 65px; text-align:center;',
'maxlength' => "2",
'minlength' => "2",
'type' => 'text'))
...
'label' => false,
'readonly' => 'readonly',
'value' => $questionaires ['UnitHeadEconomy']['economy_desc_bng'],
'type' => 'textarea',
'style' => 'text-align:center;',
'disabled' => 'disabled'))?>
</div></td>
...
<h3><span id="redmark">*</span> ৬. ইউনিটের অর্থনৈতিক কর্মকাণ্ডের<br />বিস্তারিত বিবরণ ও শিল্প কোড লিখুন </h3><hr />
<?=$this -> Form -> input('q6_economy_description', array(
'label' => false,
'readonly' => 'readonly',
'style' => 'text-align:center;',
'value' => $questionaires ['Questionaire']['q6_economy_description'],
'required' => 'required',
'type' => 'textarea', ))?>
...
'label' => false, 
'readonly' => 'readonly', 
'value' => $questionaires ['Questionaire']['q6_ind_code_class_id'], 
'style' => 'width: 65px; text-align:center;', 'maxlength' => 4, 'minlength' => 4, 'type' => 'text')) ?>
</div></td>
</tr>
