...
<?=$this -> Form -> input('q7_product_desc_1', array(
                    'label' => FALSE,
                    'value'=>$questionaires['Questionaire']['q7_product_desc_1'],
                    'type'=>'hidden'))
                    ?>
<?=$this -> Form -> input('q7_product_desc_2', array(
                    'label' => FALSE,
                    'value'=>$questionaires['Questionaire']['q7_product_desc_2'],
                    'type'=>'hidden'))
                    ?>
<?=$this -> Form -> input('q7_product_desc_3', array(
                    'label' => FALSE,
                    'value'=>$questionaires['Questionaire']['q7_product_desc_3'],
                    'type'=>'hidden'))
                    ?>
<?=$this -> Form -> input('q7_product_desc_4', array(
                    'label' => FALSE,
                    'value' => $questionaires['Questionaire']['q7_product_desc_4'],
                    'type'=>'hidden'))
                    ?>    
...
<?=$this -> Form -> input('q7_product_isright_1', array(
                    'label' => FALSE,
                    'type'=>'hidden',
                    'value'=>$questionaires['Questionaire']['q7_product_isright_1']))
                    ?>
<?=$this -> Form -> input('q7_product_isright_2', array(
                    'label' => FALSE,
                    'type'=>'hidden',
	                'value'=>$questionaires['Questionaire']['q7_product_isright_2']))
                    ?>
<?=$this -> Form -> input('q7_product_isright_3', array(
                    'label' => FALSE,
                    'type'=>'hidden',
                    'value'=>$questionaires['Questionaire']['q7_product_isright_3']))
                    ?>
<?=$this -> Form -> input('q7_product_isright_4', array(
                    'label' => FALSE,
                    'type'=>'hidden',
                    'value'=>$questionaires['Questionaire']['q7_product_isright_4']))
                    ?>                    	
...
<?=$this -> Form -> input('q8_service_desc_1', array(
                    'label' => FALSE,
                    'value'=>$questionaires['Questionaire']['q8_service_desc_1'],
                    'type'=>'hidden'))
                    ?>
<?=$this -> Form -> input('q8_service_desc_2', array(
                    'label' => FALSE,
                    'value'=>$questionaires['Questionaire']['q8_service_desc_2'],
                    'type'=>'hidden'))
                    ?>
<?=$this -> Form -> input('q8_service_desc_3', array(
                    'label' => FALSE,
                    'value'=>$questionaires['Questionaire']['q8_service_desc_3'],
                    'type'=>'hidden'))
                    ?>
<?=$this -> Form -> input('q8_service_desc_4', array(
                    'label' => FALSE,
                    'value'=>$questionaires['Questionaire']['q8_service_desc_4'],
                    'type'=>'hidden'))
                    ?>    
...
<?=$this -> Form -> input('q8_service_isright_1', array(
                    'label' => FALSE,
                    'type'=>'hidden',
                    'value' => $questionaires['Questionaire']['q8_service_isright_1']))
                    ?>
<?=$this -> Form -> input('q8_service_isright_2', array(
                    'label' => FALSE,
                    'type'=>'hidden',
                    'value' => $questionaires['Questionaire']['q8_service_isright_2']))
                    ?>
<?=$this -> Form -> input('q8_service_isright_3', array(
                    'label' => FALSE,
                    'type'=>'hidden',
                    'value' => $questionaires['Questionaire']['q8_service_isright_3']))
                    ?>
<?=$this -> Form -> input('q8_service_isright_4', array(
                    'label' => FALSE,
                    'type'=>'hidden',
                    'value' => $questionaires['Questionaire']['q8_service_isright_4']))
                    ?>  	
        ...
        <div id = "div_7">
            ...
            <table id = "sub_tbl_1">
                ...
                <tr>
                    ...
                    <td><div id="QuestionaireQ7ProductDesc1div" class="div_seven_message"><?=$questionaires['Questionaire']['q7_product_desc_1']?></div></td>
                ...
                <tr>
                    ...
                    'minlength' =>5))
                    ?></td>
                    <td><div id="QuestionaireQ7ProductDesc2div" class="div_seven_message"><?=$questionaires['Questionaire']['q7_product_desc_2']?></div></td>   
                </tr>
                ...
                <tr>
                    ...
                    'minlength' =>5))
                    ?></td>
                    <td><div id="QuestionaireQ7ProductDesc3div" class="div_seven_message"><?=$questionaires['Questionaire']['q7_product_desc_3']?></div></td>
                </tr>
                ...
                <tr>
                    ...
                    'minlength' =>5))
                    ?></td>
                    <td><div id="QuestionaireQ7ProductDesc4div" class="div_seven_message"><?=$questionaires['Questionaire']['q7_product_desc_4']?></div></td>
                </tr>
        ...
        <div id = "div_8">
            ...
            <table id = "sub_tbl_2">
                ...
                <tr>
                    ...
                    'minlength' =>5))
                    ?></td>
                    <td><div id="QuestionaireQ8ServiceDesc1div" class="div_seven_message"><?=$questionaires['Questionaire']['q8_service_desc_1']?></div></td>
                </tr>
                ...
                <tr>           
                    ...
                    'minlength' =>5))
                    ?></td>
                    <td><div id="QuestionaireQ8ServiceDesc2div" class="div_seven_message"><?=$questionaires['Questionaire']['q8_service_desc_2']?></div></td>
                </tr>
                ...
                <tr>
                    ...
                    'minlength' =>5))
                    ?></td>
                     <td><div id="QuestionaireQ8ServiceDesc4div" class="div_seven_message"><?=$questionaires['Questionaire']['q8_service_desc_4']?></div></td>
                </tr>
...
<!--  SECTION NINE-->
        <td>
        <div id = "div_9">
            <h3>৯. ইউনিটের (প্রতিষ্ঠান) আইনগত মালিকানা</h3><hr />
