...
<!-- SECTION 4 START  -->
		...
		<div id="div_4">
			...
			<hr />
			<br />
			<?php echo $this -> Form -> input('q4_unit_type', array('div' => true, 'value' => $questionaires['Questionaire']['q4_unit_type'], 'style' => 'width: 85px', 'required' => 'required', 'label' => false, 'options' => array('' => '', '1' => '1-খানা', '2' => '2-প্রতিষ্ঠান'))); ?>
			<br/>
			...
			<div id = "div_4_1" >
				...
				<?php echo $this -> Form -> input('q4_unit_org_type', array('div' => true, 'style' => 'width: 85px', 'label' => false, 'value' => $questionaires['Questionaire']['q4_unit_org_type'], 'options' => array('' => '', '1' => '1-স্থায়ী', '2' => '2-অস্থায়ী'))); ?>
			</div>
		</div></td>
