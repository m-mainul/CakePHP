...
<table border="1" style="border-collapse:collapse;border:none; text-align : center; width:100%;" id="tblExport" >
 <tr>
          <td colspan="7"><b>Table 4.1_2: Number of Establishment and Total Persons Engaged (TPE) by Sex and Services and Average Size of Establishment in 2013</b></td>
        </tr>
 <tr >
 ...
 <tr>
  <td>D</td>
  <td align="left">Electricity, Gas, Steam and Air Conditioning sSupply</td>
  <td><?= $D_Total_Estab ?></td>
...
<tr>
  <td>E</td>
  <td align="left">Water sSupply, Sewerage, Waste Management and Remediation Activities</td>
  <td><?= $E_Total_Estab ?></td>
...
<tr>
  <td>G</td>
  <td align="left">Wholesale and Retail Trade, Repair of Motor vVehicles and Motorcycles</td>
  <td><?= $G_Total_Estab ?></td>
 ...
 <tr>
  <td>H</td>
  <td align="left">Transportation and sStorage</td>
  <td><?= $H_Total_Estab ?></td>
