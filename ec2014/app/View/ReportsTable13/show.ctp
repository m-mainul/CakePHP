...
<tr>
   <td colspan="10"><b>Table- 13: Number of Establishment by Size of Current Fixed Assets, Economic Activity and Location in 2013.</b></td>
</tr>
 ...
 <tr >
  ...
  <td colspan=7>Size of Current Fixed Assets (Lac Taka)</td>
 </tr>
...
<?php 
    ...
    $UP_TO_5 += (int)$res['UP_TO_5'];
    $BET_5_50 += (int)$res['BET_5_50'];
    $BET_50_100 += (int)$res['BET_50_100'];
    $BET_100_1000 += (int)$res['BET_100_1000'];
    $BET_1000_1500 += (int)$res['BET_1000_1500'];
    $BET_1500_3000 += (int)$res['BET_1500_3000'];
    $ABOVE_3000 += (int)$res['ABOVE_3000'];
?>
