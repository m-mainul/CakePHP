...
<html lang="en">
    ...
    <head>
        ...
        // Datatables for export import
         echo $this->Html->css('/DataTables/media/css/jquery.dataTables.css');
        ...
        //Jqgrid Css
        echo $this->Html->css('jqGrid/css/ui.jqgrid.css');
        echo $this->Html->css('jquery-ui-1.9.2.custom/css/smoothness/jquery-ui-1.9.2.custom.css');

        //Select Box
        echo $this->Html->script('/js/bootstrap-select/dist/js/bootstrap-select.js');
        echo $this->Html->css('/js/bootstrap-select/dist/css/bootstrap-select.css');
                                ...
                                <ul class="nav side-menu">
                                    <li>
                                        ...
                                        <ul class="nav child_menu" style="display: none">
                                            <li><a href="<?php echo $path ?>items/lists">Item Lists</a> </li>
                                    ...
                                    <li>
                                        ...
                                        <ul class="nav child_menu" style="display: none">
                                            <li><a href="<?php echo $path ?>reports/purchase_register">Purchase Register</a> </li>
                                            <li><a href="<?php echo $path ?>reports/stock">Stock</a> </li>
                                            <li><a href="<?php echo $path ?>reports/day_book_sales">Day Book Sales</a> </li>
                                            <li><a href="<?php echo $path ?>reports/day_book_cancel">Day Book Cancel</a> </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li><a><i class="fa fa-tasks"></i> Inventory <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu" style="display: none">
                                            <li>
                                                <?php echo $this->Html->link('Vendor List',array('controller'=>'inventories','action'=>'vendors','plugin'=>false),array('escape'=>false));?>
                                            </li>
                                            <li>
                                                <?php echo $this->Html->link('List of Material',array('controller'=>'inventories','action'=>'material','plugin'=>false),array('escape'=>false));?>
                                            </li>
                                            <li>
                                                <?php echo $this->Html->link('List of Purchase',array('controller'=>'inventories','action'=>'purchase','plugin'=>false),array('escape'=>false));?>
                                            </li>
                                            <li>
                                                <?php echo $this->Html->link('List of Build Material',array('controller'=>'inventories','action'=>'build_material','plugin'=>false),array('escape'=>false));?>
                                            </li>
                                        </ul>
                                    </li>
