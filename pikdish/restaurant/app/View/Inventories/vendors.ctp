...
jQuery().ready(function() {
   var mygrid = jQuery("#list").jqGrid({
      url: base_url + 'inventories/getvendor',
      datatype: "json",
      colNames: ['Name', 'Address', 'Country', 'State', 'City', 'Mobile', 'Email'],
      colModel: [{
         name: 'name'
      }, {
         name: "address"
      ...
      ondblClickRow: function check(id) {
         window.location.href = base_url + "inventories/vendor_edit/" + lastsel2;
      },
      rowNum: 20,
      width: 1096,
   ...
   jQuery("#list").jqGrid('navButtonAdd', "#pager", {
      ...
      onClickButton: function() {
         window.location.href = base_url + "inventories/vendor_add"
      }
   });
   jQuery("#list").jqGrid('navButtonAdd', "#pager", {
      caption: "Edit",
      ...
      onClickButton: function() {
         ...
         if (gr) {
            window.location.href = base_url + "inventories/vendor_edit/" + gr;
         } else {
            $("#dialog-alert").dialog({
               height: 90,
               model: false,
               ...
               buttons: {
                  "Delete Item": function() {
                     ...
                     jQuery.ajax({
                        ...
                        cache: false,
                        dataType: 'json',
                        url: base_url + 'inventories/vendor_delete/' + gr,
...
shortcut.add("Ctrl+B", function() {
   window.location.href = base_url + 'inventories/vendors';
});
...
<div id="dialog-confirm" title="Delete Data" style="display:none" >
	<p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>This vendor will be permanently deleted and cannot be recovered. Are you sure?</p>
</div>
