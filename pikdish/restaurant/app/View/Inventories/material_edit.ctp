    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel"> <?php echo $this->Session->flash(); ?>
        <div class="x_content"> <br />
          <?php echo $this->Form->create('Material',array('class'=>'form-horizontal form-label-left')); ?>
           <div class="container">
            <div class="row clearfix">
              <div class="col-md-12 column" >
                <div class="form-group">
                    ...
                    $this->Form->input('material_code', array('label'=>false,'div'=>false, 'class'=>'form-control','placeholder'=>'Material Code'));?> </div>
                </div>
                <div class="form-group">
