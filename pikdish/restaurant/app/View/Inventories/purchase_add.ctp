                ...
                <div class="col-md-12 column" >
                    <div class="col-md-4" >
                        <div class="form-group">
                            ...
                            <div class="col-md-7 col-sm-6 col-xs-12"> <?php echo $this->Form->input('vendor_id', array('options'=>$vendor,
			'type'=>'select',
                ...
                <table class="table table-bordered table-hover" id="tab_logic">
                  ...
                  <tbody>
                    <tr class="tdr" id='addr1'>
                       ...
                       <td><select autofocus="autofocus" class="form-control" name="data[PurchaseL][0][material_id]" required="required">
                       ...
                       <td><input autofocus="autofocus" class="form-control float qty" name="data[PurchaseL][0][qty]" placeholder="Qty"  required="required"></td>
                       ...
                       <td><input autofocus="autofocus" class="form-control float rate" name="data[PurchaseL][0][rate]" placeholder="Rate"  required="required"></td>
                       <td><input autofocus="autofocus" class="form-control float tax" name="data[PurchaseL][0][tax_amt]" placeholder="Tax"  required="required"></td>
                       <td>
                    ...
                    <tr class="tdr" id='addr2'>
                       ...
                       <td><select autofocus="autofocus" class="form-control" name="data[PurchaseL][1][PurchaseH][material_id]" required="required">
                               <option valie="">-- Select Material --</option>
                               <?php foreach($material as $key=>$list){
                                  echo '<option value="'.$key.'">'.$list.'</option>'; 
                               }?>
                           </select></td>
                       <td><input autofocus="autofocus" class="form-control float qty" name="data[PurchaseL][1][qty]"  placeholder="Qty" required="required"></td>
                       <td>
                       <select autofocus="autofocus" class="form-control" name="data[PurchaseL][1][unit_id]" required="required">
                               <option valie="">-- Select Unit --</option>
                               <?php foreach($unit as $key=>$list){
                                  echo '<option value="'.$key.'">'.$list.'</option>'; 
                               }?>
                           </select></td>
                       <td><input autofocus="autofocus" class="form-control float rate" name="data[PurchaseL][1][rate]" placeholder="Rate"   required="required"></td>
                       <td><input autofocus="autofocus" class="form-control float tax" name="data[PurchaseL][1][tax_amt]" placeholder="Tax" required="required"  ></td>
                       <td>
                          <div style='font-size:20px; cursor:pointer;'>
