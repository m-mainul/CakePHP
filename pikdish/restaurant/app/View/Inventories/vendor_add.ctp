    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel"> <?php echo $this->Session->flash(); ?>
        <div class="x_content"> <br />
          <?php echo $this->Form->create('Vendor',array('url'=>'vendor_add','method'=>'post','name'=>'editForm','class'=>'form-horizontal form-label-left') ); ?>
           <div class="container">
			...
			'label'=>false,'div'=>false, 'empty'=>'-- Select Country --'));?> </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-sm-6 col-xs-12"> <?php echo $this->Form->input('state_id', array('options'=>array(),
			'type'=>'select',
			'class'=>'form-control selectpicker col-md-7 col-xs-12',
			'autocomplete'=>'off',
                        "data-live-search"=>"true",
			...
			'label'=>false,'div'=>false, 'empty'=>'-- Select State --'));?> </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-sm-6 col-xs-12"> <?php echo $this->Form->input('city_id', array('options'=>array(),
			'type'=>'select',
			'class'=>'form-control selectpicker col-md-7 col-xs-12',
			'autocomplete'=>'off',
                        "data-live-search"=>"true",
