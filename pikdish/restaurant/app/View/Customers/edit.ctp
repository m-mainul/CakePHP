  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel"> <?php echo $this->Session->flash(); ?>
        <div class="x_content"> <br />
          ...
          <?php echo $this->Form->create('User',array('url' => 'edit','method'=>'post','name'=>'editForm','class'=>'form-horizontal form-label-left',	  'enctype'=>'multipart/form-data') ); 
		  echo $this->Form->hidden('User.id');
		  ?>
         <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Mobile <span class="required">*</span> </label>
            <div class="col-md-6 col-sm-6 col-xs-12"> <?php echo $this->Form->input('User.mobile_no', array('required'=>'true', 'class' => 'form-control col-md-7 col-xs-12','label' => false, 'div' => false,'type'=>'text','readonly'=>true,'placeholder'=>'Mobile No.[xxxxxxxxxx]','pattern'=>"[789]\d{9}"));?> 
    <label id="mobile-error" class="error control-label col-md-3 col-sm-3 col-xs-12" style="width:100%; text-align:left; float:left; display:none"></label>           </div>
         ...
         <div class="form-group">
		   ...
		   <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12"> <?php echo $this->Form->input('User.password', array('required'=>'false','value'=>"", 'class' => 'form-control col-md-7 col-xs-12','label' => false, 'div' => false,'placeholder'=>'Password','pattern'=>'^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,16}$','title'=>"Password must be between 7 to 15 characters contain at least one numeric digit and a special character"));?></div>
          </div>
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Confirm Password <span class="required">*</span> </label>
            <div class="col-md-6 col-sm-6 col-xs-12"> <?php echo $this->Form->input('confirm_password', array('required'=>false, 'class' => 'form-control col-md-7 col-xs-12','label' => false, 'div' => false,'type'=>'password','placeholder'=>'Confirm Password','pattern'=>'^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,16}$'));?></div>
          </div>
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Name <span class="required">*</span> </label>
            <div class="col-md-6 col-sm-6 col-xs-12"> <?php echo $this->Form->input('User.name', array('required'=>'true', 'class' => 'form-control col-md-7 col-xs-12','label' => false,'autofocus'=>true, 'div' => false,'type'=>'text','placeholder'=>'Customer Name','pattern'=>"^[A-z ]{2,}$",'title'=>'Digit or Special Characters are not allow'));?> </div>
          </div>
          <div class="form-group">
    ...
    <label id="customer-error" class="error control-label col-md-3 col-sm-3 col-xs-12" style="width:100%; text-align:left; float:left; display:none"></label>           </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12"> <?PHP if($this->request->data['User']['gender'] == 0)
                    { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12" style="padding-top:8px"> <?  if($this->request->data['User']['food_type_id'] == 0){?>
                 ...
                 <? }else { ?><input    type="radio" name="data[User][food_type_id]" value="0" /><img src='<?=$imgpath?>/green.jpg' title="Veg" width='24'  /> Veg <input  type="radio" value="1" name="data[User][food_type_id]" checked="checked"  required/><img src='<?=$imgpath?>/red.jpg' width='26' title="Non-Veg"  />Non-Veg <? } ?></div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
		   ...
		   <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12"> <?php echo $this->Form->input('User.user_pic', array('type'=>'file', 'class' => 'form-control col-md-7 col-xs-12','label' => false, 'div' => false));?>
             <div><a data-lightbox="example-1" href="<?=$userimg.$this->request->data['User']['user_pic']?>"><img  src="<?=$userimg.$this->request->data['User']['user_pic']?>" style="width:100px; height:100px; border:solid 2px #CCC;padding:5px 5px;padding-left:5px; margin-left:12px" /></a></div>
             </div>
          </div>
          <div class="form-group">
...
function check_mail(){
	...
	if(id != '<?=$this->request->data['User']['email']?>'  && id != '<?=$this->request->data['User']['username']?>')
	{
	if(pattern.test(id)){
	jQuery.ajax({
...
function check_mobile(){
	...
	pattern=/^[789]\d{9}$/;
	if(val != <?=$this->request->data['User']['mobile_no']?> )
	{
	 if(pattern.test(val)){
	 jQuery.ajax({
