...
<div class="">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      ...
      <?php echo $this->Form->create('User',array('url' => 'edit','method'=>'post','name'=>'addForm','class'=>'form-horizontal form-label-left',"enctype"=>"multipart/form-data") );
    ...
    <label id="mobile-error" class="error control-label col-md-3 col-sm-3 col-xs-12" style="width:100%; text-align:left; float:left; display:none"></label>           </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-7 col-sm-6 col-xs-12"> <?php echo $this->Form->input('User.state_id', array('required'=>'true', 'class' => 'form-control col-md-7 col-xs-12 selectpicker show-menu-arrow','label' => false, 'div' => false,"data-live-search"=>"true", "data-live-search-style"=>"begins", "title"=>"Select State",'onchange'=>'change_state("UserStateId","UserCityId")','options'=>$u_states));?> </div>
          </div>

          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">City <span class="required">*</span> </label>
            <div class="col-md-7 col-sm-6 col-xs-12"> <?php echo $this->Form->input('User.city_id', array('required'=>'true', 'class' => 'form-control col-md-7 col-xs-12 selectpicker show-menu-arrow','label' => false, 'div' => false,"data-live-search"=>"true", "data-live-search-style"=>"begins", "title"=>"Select City",'options'=>$u_cities));?> </div>
          </div>
     ...
     <div style=" float:right"><a href="javascript:void(0)" onclick="tab1()" class="btn btn-primary">Next</a> </div>
        ...
        <div class="form-group">
            ...
            <input type="checkbox" id="mobile" value="1"   /><label  class="control-label ">Same as Owner.</label>
            </div>
         </div>
          <div class="form-group">
         ...
         <script>
		     $('#mobile').change(function(event)
			 {
				 ...
				 }else
				 {
					 ...
					 $( "#RestaurantMobileNo" ).attr({'readonly':false}).val('<?=$this->request->data['Restaurant']['mobile_no']?>');
				 }

			 });
			 if('<?=$this->request->data['Restaurant']['mobile_no']?>' ==  '<?=$this->request->data['User']['mobile_no']?>')
			 {
				 $('#mobile').attr('checked',true);
				 $( "#RestaurantMobileNo" ).attr({'readonly':true});
			 }
		 </script>
          ...
          <script>
		     $('#email').change(function(event)
			 {
				 ...
				 {
					 $( "#RestaurantEmail" ).attr({'readonly':false}).val('<?=$this->request->data['Restaurant']['email']?>');
				 }

			 });

			  if('<?=$this->request->data['Restaurant']['email']?>' ==  '<?=$this->request->data['User']['email']?>')
			 {
				 $('#email').attr('checked',true);
				 $( "#RestaurantEmail" ).attr({'readonly':true});
			 }
		 </script>
         <div class="form-group">
         ...
         <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-7 col-sm-6 col-xs-12" style="padding-top:8px">
             ...
             <?php } elseif($this->request->data['Restaurant']['food_type_id'] == 2) { ?>
	             	<input type="radio" name="data[Restaurant][food_type_id]" value="0" />
	             	<img src='<?=$imgpath?>/green.jpg' title="Veg" width='24'/> Veg
	             	<input  type="radio" value="1" name="data[Restaurant][food_type_id]" required />
	             	<img src='<?=$imgpath?>/red.jpg' width='26' title="Non-Veg" />Non-Veg
	             	<input type="radio" name="data[Restaurant][food_type_id]" value="2" checked="checked" />
	             	<img src='<?=$imgpath?>/green.jpg' title="Both" width='24'/> Both
             <?php } else { ?>
	             	<input type="radio" name="data[Restaurant][food_type_id]" value="0" />
	             	<img src='<?=$imgpath?>/green.jpg' title="Veg" width='24'/> Veg
	             	<input  type="radio" value="1" name="data[Restaurant][food_type_id]" required  checked="checked" />
	             	<img src='<?=$imgpath?>/red.jpg' width='26' title="Non-Veg" />Non-Veg
	             	<input type="radio" name="data[Restaurant][food_type_id]" value="2" />
	             	<img src='<?=$imgpath?>/green.jpg' title="Both" width='24'/> Both
             <?php } ?>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12"> <?php echo $this->Form->input('Restaurant.logo_path', array('type'=>'file', 'class' => 'form-control col-md-7 col-xs-12','label' => false, 'div' => false));?>
 ...
 <div style=" float:right"><a href="javascript:void(0)" onclick="tab2(0,1,2)" class="btn btn-primary">Next</a> </div>
          ...
          <div class="form-group">
                ...
                <div id="map" class="col-md-10 col-sm-10 col-xs-12" style=" width:100%; height:500px; margin-top:10px; margin-bottom:10px; border:1px "></div>           <input id="locationTextField" type="text" class="form-control col-md-7 col-xs-12 controls "  >
                </div>
...
function check_username(){
	id=$( "#UserEmail" ).val()
	if(id!=="" && id !== "<?=$this->request->data['User']['username']?>" && id !== "<?=$this->request->data['User']['email']?>" && id !== "<?=$this->request->data['Restaurant']['email']?>")
	{
	            	pattern=/^[-a-zA-Z0-9@:%_\+.~#?&//=]{2,256}\.[a-z]{2,4}\b(\/[-a-zA-Z0-9@:%_\+.~#?&//=]*)?$/;
	                if(pattern.test(id))
					{
                                    ...
                                    success: function(response)
									{
									   if(response.status=="error")
									   {
									    $("#customer-error")
										  ...
										  document.getElementById("UserEmail").setCustomValidity("Please Specified different Username !");
...
//$( "#UserEmail" ).keyup(check_username);
$( "#UserEmail" ).change(check_username);

function check_mail(){
	id=$( "#RestaurantEmail" ).val()

	if(id!=="" && !$('#email').is(':checked') && id !== "<?=$this->request->data['User']['username']?>" && id !== "<?=$this->request->data['User']['email']?>" && id !== "<?=$this->request->data['Restaurant']['email']?>" )
	{
...
function check_mobile(mobile_id,error_label){
	...
	if(val!=="" && val !== "<?=$this->request->data['User']['mobile_no']?>"  && val !== "<?=$this->request->data['Restaurant']['mobile_no']?>")
	{
...
function tab1()
{
   ...
   cstatus = document.getElementById('UserStatus');
		...
		if(!username.validity.valid  || !cname.validity.valid  || !email.validity.valid || !mobile.validity.valid || !dob.validity.valid || !country.validity.valid || !state.validity.valid || !city.validity.valid  || !cstatus.validity.valid  )
		{
		    $("#submit").click();
		}
		else
...
function tab2(a,b,c)
{
    ...
    //                $('#RestaurantAutoCancelTime').attr({
		...
		if(!rname.validity.valid || !contact_person.validity.valid || !contact_name.validity.valid || !website.validity.valid || !remail.validity.valid || !mobile_no.validity.valid || !tin_no.validity.valid || !sc.validity.valid  || !address.validity.valid || !country.validity.valid || !state.validity.valid || !city.validity.valid   ||  !cancel_time.validity.valid ||  !rtype.validity.valid)
		{
		    $("#submit").click();
		}
		else
