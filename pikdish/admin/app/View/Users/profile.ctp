      ...
      <div class="x_panel"> <?php echo $this->Session->flash(); ?>
        <div class="x_content"> <br />
         ...
         <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12"> <?php echo $this->Form->input('User.username', array('required'=>'false','disabled'=>'disabled', 'class' => 'form-control col-md-7 col-xs-12','label' => false, 'div' => false,'type'=>'email','placeholder'=>'Username','pattern'=>'[-a-zA-Z0-9@:%_\+.~#?&//=]{2,256}\.[a-z]{2,4}\b(\/[-a-zA-Z0-9@:%_\+.~#?&//=]*)?'));?>
             </div>
         </div>
         <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Name <span class="required">*</span> </label>
            <div class="col-md-6 col-sm-6 col-xs-12"> <?php echo $this->Form->input('User.name', array('required'=>'true', 'class' => 'form-control col-md-7 col-xs-12','label' => false, 'div' => false,'autofocus'=>true, 'placeholder'=>'Name','pattern'=>'[a-zA-Z ]{2,256}'));?>
             </div>
         </div>
         <div class="form-group">
	     ...
	     <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12"> <?php echo $this->Form->input('User.mobile_no', array('required'=>'true', 'class' => 'form-control col-md-7 col-xs-12','label' => false,'div' => false,'type'=>'text','placeholder'=>'Mobile No.[xxxxxxxxxx]','pattern'=>"[789]\d{9}"));?>             
             <label id="mobile-error" class="error control-label col-md-3 col-sm-3 col-xs-12" style="width:100%; text-align:left; float:left; display:none"></label>
            </div>
          </div>
          <div class="form-group">
