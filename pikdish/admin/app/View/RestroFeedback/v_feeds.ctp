...
<div class="title_left" style="margin-left:5px; width:40%">
  <button type="button"  class="btn btn-primary btn-lg " style="border-radius:5px" onclick="get_selected(0)">Unverified Selected</button>     
</div>
<div class="title_right table-responsive" style="float:right; text-align:right; margin-right:5px">
      <nav aria-label="Page navigation ">
          <ul class="pagination pagination-lg" >
            ...
            <li ><a href="<?=$path?>restro_feedback/v_feedslist/<?=$restor_id?>"><span class="glyphicon glyphicon glyphicon-th-large" aria-hidden="true"></span></a></li>
          </ul>
        </nav>
</div>
</div>
...
var mygrid = jQuery("#list").jqGrid({
	url:'<?php echo $path; ?>Restro_Feedback/feedjson/<?=$restor_id?>/1',
	datatype: "json",
	...
	rownumWidth: 40,
	shrinkToFit: true,
	caption:"Verified Customer Feedbacks List",
...
<div id="dialog-Verify" title="Unverified Feedbacks" style="display:none" >
	<p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>These feedbacks are verified. Are you sure, you want to unverified these feedbacks?</p>
</div>
