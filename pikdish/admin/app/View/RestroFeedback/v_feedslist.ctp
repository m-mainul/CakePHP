...
<div class="title_left" style="width:50%; float:left"><h1>Verified Customer Feedbacks </h1></div>
<div class="title_right table-responsive" style="float:right; text-align:right; margin-right:5px; width:40%">
      <nav aria-label="Page navigation ">
          <ul class="pagination pagination-lg" >
            <li ><a href="<?=$path?>restro_feedback/v_feeds/<?=$restor_id?>"><span class="glyphicon glyphicon glyphicon-th-list" aria-hidden="true"></span></a></li>
...
<div class="x_panel" >                
    ...
    <div class="title_right" style="margin-left:5px; width:40%; float:right; text-align:right">
      <button type="button"  class="btn btn-primary btn-lg " style="border-radius:5px" onclick="get_selected(2)">Unverified Selected</button>     
     </div>
			...
			buttons: {
				"Unverified": function() {
					...
					jQuery.ajax({
                                    ...
                                    cache: false,
                                    dataType: 'json',
                                    url: '<?php echo $path;?>/restro_feedback/unvarify/' + id+'/'+type ,
...
function load_contents(type=0,src_val=""){
     ...
     if(loading == false){
        ...
        $.post( '<?=$path?>restro_feedback/getPro', {'restro_id':<?=$restor_id?>,'page': track_page,"type":1,
		'rating':rating,
		'order':order,
		'records':records,
		"search":src_val
...
<div id="dialog-delete" title="Unverified Feedback" style="display:none" >
...
<div id="dialog-delete_1" title="Unverified Feedbacks" style="display:none" >
	<p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>Thses feedbacks are verified. Are you sure, you want to unverified these feedbacks?</p>
</div>
