...
<div class="title_left" style="width:50%; float:left"><h1>Deleted Customer Feedbacks </h1></div>
<div class="title_right table-responsive" style="float:right; text-align:right; margin-right:5px; width:40%">
      <nav aria-label="Page navigation ">
          <ul class="pagination pagination-lg" >
            <li ><a href="<?=$path?>restro_feedback/d_feeds/<?=$restor_id?>"><span class="glyphicon glyphicon glyphicon-th-list" aria-hidden="true"></span></a></li>
