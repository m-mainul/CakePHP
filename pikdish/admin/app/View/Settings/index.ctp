        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel"><?php echo $this->Session->flash(); ?><div class="x_content">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">App online<span class="required">*</span> </label>
                            <div class="col-md-6 col-sm-6 col-xs-12"> <?php echo $this->Form->input('Setting.is_app_online', array('required' => 'true', 'class' => 'form-control col-md-7 col-xs-12 show-menu-arrow', 'options' => array(1 => 'Yes', 0 => 'No'), 'label' => false, 'div' => false, "title" => "Select status")); ?> </div>
                        </div>

                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Website online<span class="required">*</span> </label>
                            <div class="col-md-6 col-sm-6 col-xs-12"> <?php echo $this->Form->input('Setting.is_website_online', array('required' => 'true', 'class' => 'form-control col-md-7 col-xs-12 show-menu-arrow', 'options' => array(1 => 'Yes', 0 => 'No'), 'label' => false, 'div' => false, "title" => "Select status")); ?> </div>
                        </div>
