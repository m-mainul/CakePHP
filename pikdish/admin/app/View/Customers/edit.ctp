    ...
    <label id="mobile-error" class="error control-label col-md-3 col-sm-3 col-xs-12" style="width:100%; text-align:left; float:left; display:none"></label>           </div>
         ...
         <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12"> <?php echo $this->Form->input('confirm_password', array('required'=>false, 'class' => 'form-control col-md-7 col-xs-12','label' => false, 'div' => false,'type'=>'password','placeholder'=>'Xerox Password','pattern'=>'^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,16}$'));?></div>
          </div>
          <div class="form-group">
